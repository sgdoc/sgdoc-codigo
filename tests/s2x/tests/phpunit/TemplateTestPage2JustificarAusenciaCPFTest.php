 ...
 */
class ManterPessoaFisicaSgdoceSuite1CadastrarPessoaFisica2JustificarAusenciaCPF extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "2JustificarAusenciaCPF");
...
| ensure | do | type | on | id=txJustificativa | with | justificativa com mais de cinco palabras |
| ensure | do | click | on | id=btn-concluir-justificativa |
| check | is | verifyText | on | css=fieldset &gt; div.alert.alert-error | ×Para incluir um cadastro sem informar o CPF, deverá ser informado o login e senha de um usuário com perfil de chefe do setor ou substituto. |
| do | close | on |  |
| stop browser |
');
