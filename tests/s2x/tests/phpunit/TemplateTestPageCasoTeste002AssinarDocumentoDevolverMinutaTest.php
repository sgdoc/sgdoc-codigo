 ...
 */
class ManterMinutaEletronicaSuite2AssinarDocumentoCasoTeste002AssinarDocumentoDevolverMinuta extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste002AssinarDocumentoDevolverMinuta");
