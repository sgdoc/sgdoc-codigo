 ...
 */
class ManterModeloDeMinutaSuite1PesquisarModeloMinutaCasoTeste003PesquisarModeloMinutaTipoDocumentoAssuntoNaoCadastrado extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        $this->open("/ProjectSgdoc.ManterModeloDeMinuta.Suite1PesquisarModeloMinuta");
        $this->click("link=Add");
        $this->click("link=Test page");
        $this->waitForPageToLoad("30000");
        $this->type("id=pagename", "CasoTeste003PesquisarModeloMinutaTipoDocumentoAssuntoNaoCadastrado");
