 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste110AlterarPessoaFisicaContatoExcluirRegistroLista extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste110AlterarPessoaFisicaContatoExcluirRegistroLista");
...
| ensure | do | click | on | !-//*[@id="table-email"]/tbody/tr/td[contains(.,"Particular")]/../td[3]/a[@title="Excluir"]-! | with | Particular |
| ensure | do | click | on | xpath=(//a[contains(text(),"Sim")])[3] |
| ensure | do | waitForText | on | //body/div[6]/div[2]/div | with | Exclusão realizada com sucesso. |
