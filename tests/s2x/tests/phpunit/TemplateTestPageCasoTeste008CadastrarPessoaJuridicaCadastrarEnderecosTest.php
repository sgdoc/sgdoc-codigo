 ...
 */
class ManterPessoaJuridicaSgdoceSuite2CadastrarPessoaJuridicaCasoTeste008CadastrarPessoaJuridicaCadastrarEnderecos extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste008CadastrarPessoaJuridicaCadastrarEnderecos");
...
| check | is | assertText | on | !-//*[@id="table-endereco"]/tbody/tr/td[contains(.,"$nuCep")]/../td[2]-! | $nuCep |
| stop browser |
');
