 ...
 */
class ManterModeloDeMinutaSuite2ModeloMinutaPadraoOficioCasoTeste005ModeloMinutaPadraoOficioIncluirConfidencial extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste005ModeloMinutaPadraoOficioIncluirConfidencial");
