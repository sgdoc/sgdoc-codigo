 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste064AlterarPessoaFisicaDocumentosCNH extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste064AlterarPessoaFisicaDocumentosCNH");
...
| ensure | do | click | on | !-//*[@id="table-documento"]/tbody/tr/td[contains(.,"Carteira de Motorista")]/../td[4]/div/a[@title="Alterar"]-! | with | Carteira de Motorista |
| ensure | do | waitForText | on | css=h3.title-main | with | Alterar Documento |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[14]/label/following-sibling::div/input[4]-! | with | 1111111 |
| ensure | do | select | on | !-//form[@id="form-documento-modal"]/fieldset/div[15]/label/following-sibling::div/select-! | with | label=Goiás |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[16]/label/following-sibling::div/div/input-! | with | 01/01/2002 |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[20]/label/following-sibling::div/div/input-! | with | 01/01/2006 |
| stop browser |
');
