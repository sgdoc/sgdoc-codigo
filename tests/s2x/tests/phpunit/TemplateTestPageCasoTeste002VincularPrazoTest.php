 ...
 */
class VincularPrazoSuite2VincularPrazoCasoTeste002VincularPrazo extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste002VincularPrazo");
