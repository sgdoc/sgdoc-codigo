 ...
 */
class ManterModeloDeCarimboSuite4ExcluirModeloCarimboCasoTeste008ExcluirModeloCarimboConfirmarExclusao extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste008ExcluirModeloCarimboConfirmarExclusao");
