 ...
 */
class ManterModeloDeMinutaSuite6ExcluirModeloMinutaCasoTeste003ExcluirModeloMinutaPadraoModeloMinutaExclursao extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        $this->open("/ProjectSgdoc.ManterModeloDeMinuta.Suite6ExcluirModeloMinuta");
        $this->click("link=Add");
        $this->click("link=Test page");
        $this->waitForPageToLoad("30000");
        $this->type("id=pagename", "CasoTeste003ExcluirModeloMinutaPadraoModeloMinutaExclursao");
