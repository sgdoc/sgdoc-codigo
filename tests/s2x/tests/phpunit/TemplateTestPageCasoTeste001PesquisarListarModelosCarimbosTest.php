 ...
 */
class ManterModeloDeCarimboSuite1PesquisarListarModeloCarimboCasoTeste001PesquisarListarModelosCarimbos extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        $this->open("/ProjectSgdoc.ManterModeloDeCarimbo.Suite1PesquisarListarModeloCarimbo");
        $this->click("link=Add");
        $this->click("link=Test page");
        $this->waitForPageToLoad("30000");
        $this->type("id=pagename", "CasoTeste001PesquisarListarModelosCarimbos");
...
| ensure | do | assertElementPresent | on | !-//table[@id="table-grid"]/thead/tr/th-! |
| ensure | do | assertElementPresent | on | !-//table[@id="table-grid"]/thead/tr/th[2]-! |
| stop browser |
');
