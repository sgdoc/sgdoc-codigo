 ...
 */
class ManterPessoaFisicaSgdoceSuite1CadastrarPessoaFisica3CadastroDocumentosCNH extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "3CadastroDocumentosCNH");
...
| ensure | do | select | on | id=sqTipoDocumento | with | label=Carteira de Motorista |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[14]/label/following-sibling::div/input[3]-! | with | 1111111 |
| ensure | do | select | on | !-//form[@id="form-documento-modal"]/fieldset/div[15]/label/following-sibling::div/select-! | with | label=Distrito Federal |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[16]/label/following-sibling::div/div/input-! | with | 01/01/2001 |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[20]/label/following-sibling::div/div/input-! | with | 01/01/2005 |
