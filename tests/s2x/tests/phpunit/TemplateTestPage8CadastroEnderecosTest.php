 ...
 */
class ManterPessoaFisicaSgdoceSuite1CadastrarPessoaFisica8CadastroEnderecos extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "8CadastroEnderecos");
...
| ensure | do | select | on | id=sqTipoEndereco | with | label=Contato |
