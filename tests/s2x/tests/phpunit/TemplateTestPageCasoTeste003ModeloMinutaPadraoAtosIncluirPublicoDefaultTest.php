 ...
 */
class ManterModeloDeMinutaSuite3ModeloMinutaPadraoAtosCasoTeste003ModeloMinutaPadraoAtosIncluirPublicoDefault extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste003ModeloMinutaPadraoAtosIncluirPublicoDefault");
