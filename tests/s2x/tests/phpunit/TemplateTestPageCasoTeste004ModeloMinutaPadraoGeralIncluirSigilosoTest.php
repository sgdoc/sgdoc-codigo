 ...
 */
class ManterModeloDeMinutaSuite4ModeloMinutaPadraoGeralCasoTeste004ModeloMinutaPadraoGeralIncluirSigiloso extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste004ModeloMinutaPadraoGeralIncluirSigiloso");
