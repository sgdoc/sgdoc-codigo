 ...
 */
class VisualizarCaixaDeMinutasSuite1CaixasMinutasRecebidasCasoTeste005CaixaMinutasRecebidasAcompanharMinuta extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste005CaixaMinutasRecebidasAcompanharMinuta");
