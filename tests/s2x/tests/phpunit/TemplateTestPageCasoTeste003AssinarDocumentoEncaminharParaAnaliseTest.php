 ...
 */
class ManterMinutaEletronicaSuite2AssinarDocumentoCasoTeste003AssinarDocumentoEncaminharParaAnalise extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        $this->open("/ProjectSgdoc.ManterMinutaEletronica.Suite2AssinarDocumento");
        $this->click("link=Add");
        $this->click("link=Test page");
        $this->waitForPageToLoad("30000");
        $this->type("id=pagename", "CasoTeste003AssinarDocumentoEncaminharParaAnalise");
