 ...
 */
class ManterTipoDeDocumentoSuite3AlterarTipoDocumentoCasoTeste008AterarTipoDocumentoTipoDocumentoJaCadastrado extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste008AterarTipoDocumentoTipoDocumentoJaCadastrado");
