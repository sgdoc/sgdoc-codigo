 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste067AlterarPessoaFisicaDocumentosCNHUploadImagem extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste067AlterarPessoaFisicaDocumentosCNHUploadImagem");
...
| ensure | do | type | on | id=txImagem | with | $path_to_attach\png\CNH.png |
| ensure | do | clickAndWait | on | xpath=(//a[contains(text(),"Concluir")])[2] | with | Concluir |
