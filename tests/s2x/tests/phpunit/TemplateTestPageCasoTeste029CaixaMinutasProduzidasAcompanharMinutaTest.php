 ...
 */
class VisualizarCaixaDeMinutasSuite4CaixasMinutasProduzidasCasoTeste029CaixaMinutasProduzidasAcompanharMinuta extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste029CaixaMinutasProduzidasAcompanharMinuta");
