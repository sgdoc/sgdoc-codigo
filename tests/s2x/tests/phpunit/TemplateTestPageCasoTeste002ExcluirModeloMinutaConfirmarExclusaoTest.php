 ...
 */
class ManterModeloDeMinutaSuite6ExcluirModeloMinutaCasoTeste002ExcluirModeloMinutaConfirmarExclusao extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste002ExcluirModeloMinutaConfirmarExclusao");
