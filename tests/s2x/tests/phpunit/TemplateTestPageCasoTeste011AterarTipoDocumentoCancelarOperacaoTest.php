 ...
 */
class ManterTipoDeDocumentoSuite3AlterarTipoDocumentoCasoTeste011AterarTipoDocumentoCancelarOperacao extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste011AterarTipoDocumentoCancelarOperacao");
...
| ensure | do | click | on | id=cancelar |
