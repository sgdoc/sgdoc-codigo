 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste073AlterarPessoaFisicaDocumentosRGDataInvalida extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste073AlterarPessoaFisicaDocumentosRGDataInvalida");
...
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[24]/label/following-sibling::div/div/input-! | with | 00/00/0000 |
