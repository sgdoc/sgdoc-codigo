 ...
 */
class VisualizarCaixaDeMinutasSuite1CaixasMinutasRecebidasCasoTeste004CaixaMinutasRecebidasRealizarAcoesMultiplasMinutasNaoSelecionadas extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste004CaixaMinutasRecebidasRealizarAcoesMultiplasMinutasNaoSelecionadas");
