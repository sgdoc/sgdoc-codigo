 ...
 */
class ManterTipoDePrioridadeSuite1ListarTipoPrioridadeCasoTeste001ListarTipoPrioridade extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        $this->open("/ProjectSgdoc.ManterTipoDePrioridade.Suite1ListarTipoPrioridade");
        $this->click("link=Add");
        $this->click("link=Test page");
        $this->waitForPageToLoad("30000");
        $this->type("id=pagename", "CasoTeste001ListarTipoPrioridade");
...
| check | is | verifyText | on | css=th.header.headerSortDown | Descrição |
| check | is | verifyText | on | !-//table[@id="table-grid"]/thead/tr/th[2]-! | Prioridade |
| stop browser |
');
