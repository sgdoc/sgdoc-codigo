 ...
 */
class ManterTipoDeDocumentoSuite2IncluirTipoDocumentoCasoTeste007IncluirTipoDocumentoCancelarOperacao extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste007IncluirTipoDocumentoCancelarOperacao");
...
| ensure | do | clickAndWait | on | id=cancelar |
| ensure | do | waitForText | on | css=h1 | with | Pesquisar Tipo de Documento |
| stop browser |
');
