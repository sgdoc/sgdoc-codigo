 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste060AlterarDadosBasicosDataInvalida extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste060AlterarDadosBasicosDataInvalida");
...
| ensure | do | type | on | id=dtNascimento | with | 00/00/0000 |
