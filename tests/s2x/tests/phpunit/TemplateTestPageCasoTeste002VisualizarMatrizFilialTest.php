 ...
 */
class ManterPessoaJuridicaSgdoceSuite1VisualizarPessoaJuridicaCasoTeste002VisualizarMatrizFilial extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste002VisualizarMatrizFilial");
