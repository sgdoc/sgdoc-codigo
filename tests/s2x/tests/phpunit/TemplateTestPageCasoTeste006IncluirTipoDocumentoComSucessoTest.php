 ...
 */
class ManterTipoDeDocumentoSuite2IncluirTipoDocumentoCasoTeste006IncluirTipoDocumentoComSucesso extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste006IncluirTipoDocumentoComSucesso");
...
| ensure | do | clickAndWait | on | css=button.btn.btn-primary |
| check | is | assertText | on | css=div.alert.alert-success | × Inclusão realizada com sucesso. |
| stop browser |
');
