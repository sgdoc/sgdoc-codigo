 ...
 */
class ManterPessoaJuridicaSgdoceSuite2CadastrarPessoaJuridicaCasoTeste015CadastrarPessoaJuridicaCadastrarEmail extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste015CadastrarPessoaJuridicaCadastrarEmail");
...
| $nmEmail= | is | storeExpression | on | !-emailteste@teste.com.br-! |
...
| ensure | do | select | on | id=sqTipoEmail | with | label=$nmTipoEmail |
...
| check | is | assertText | on | !-//*[@id="table-email"]/tbody/tr/td[contains(.,"$nmTipoEmail")]/../td[2]-! | $nmEmail |
| do | close | on |  |
| stop browser |
');
