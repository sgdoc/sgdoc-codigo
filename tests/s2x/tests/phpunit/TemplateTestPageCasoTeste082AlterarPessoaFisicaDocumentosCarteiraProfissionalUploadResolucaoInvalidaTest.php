 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste082AlterarPessoaFisicaDocumentosCarteiraProfissionalUploadResolucaoInvalida extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste082AlterarPessoaFisicaDocumentosCarteiraProfissionalUploadResolucaoInvalida");
...
| ensure | do | clickAndWait | on | xpath=(//a[contains(text(),"Concluir")])[2] |
| ensure | do | waitForText | on | !-//div[@id="modalDocumento"]/div/div-! | with | ×A dimensão da imagem deve ser de no mínimo de 200x200 pixels e máximo 1000x1000 pixels. |
