 ...
 */
class ManterPessoaJuridicaSgdoceSuite4ExcluirDadosPessoaJuridicaCasoTeste033ExcluirDadosPessoaJuridicaExcluirEmail extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste033ExcluirDadosPessoaJuridicaExcluirEmail");
...
| ensure | do | click | on | !-//*[@id="table-email"]/tbody/tr/td[contains(.,"$nmTipoEmail")]/../td[3]/a[@title="Excluir"]-! | with | $nmTipoEmail |
...
| ensure | do | assertTextNotPresent | on | !-//*[@id="table-email"]/tbody/tr/td[contains(.,"$nmTipoEmail")]-! |
| do | close | on |  |
| stop browser |
');
