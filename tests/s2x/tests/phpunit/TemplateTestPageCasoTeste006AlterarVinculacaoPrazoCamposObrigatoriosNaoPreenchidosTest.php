 ...
 */
class VincularPrazoSuite3AterarVinculacaoPrazoCasoTeste006AlterarVinculacaoPrazoCamposObrigatoriosNaoPreenchidos extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste006AlterarVinculacaoPrazoCamposObrigatoriosNaoPreenchidos");
...
| ensure | do | type | on | id=sqAssunto |
| ensure | do | type | on | id=inPrazoObrigatorio |
