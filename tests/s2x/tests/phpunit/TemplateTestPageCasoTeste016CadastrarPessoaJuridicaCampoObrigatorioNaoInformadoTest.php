 ...
 */
class ManterPessoaJuridicaSgdoceSuite2CadastrarPessoaJuridicaCasoTeste016CadastrarPessoaJuridicaCampoObrigatorioNaoInformado extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste016CadastrarPessoaJuridicaCampoObrigatorioNaoInformado");
