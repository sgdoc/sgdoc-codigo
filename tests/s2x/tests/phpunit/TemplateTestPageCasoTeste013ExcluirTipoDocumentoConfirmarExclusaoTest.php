 ...
 */
class ManterTipoDeDocumentoSuite4ExcluirTipoDocumentoCasoTeste013ExcluirTipoDocumentoConfirmarExclusao extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste013ExcluirTipoDocumentoConfirmarExclusao");
