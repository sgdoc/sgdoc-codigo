 ...
 */
class CadastrarSequencialDeUnidadeOrganizacionalSuite2AlterarNumeroSequencialCasoTeste004AlterarNumeroSequencialProcessoComDuplicidade extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste004AlterarNumeroSequencialProcessoComDuplicidade");
