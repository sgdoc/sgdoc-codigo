 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste104AlterarPessoaFisicaEnderecoExcluirRegistroLista extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste104AlterarPessoaFisicaEnderecoExcluirRegistroLista");
