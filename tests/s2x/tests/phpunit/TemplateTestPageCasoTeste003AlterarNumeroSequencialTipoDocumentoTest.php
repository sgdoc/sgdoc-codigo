 ...
 */
class CadastrarSequencialDeUnidadeOrganizacionalSuite2AlterarNumeroSequencialCasoTeste003AlterarNumeroSequencialTipoDocumento extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste003AlterarNumeroSequencialTipoDocumento");
...
| ensure | do | type | on | id=nuSequencial | with | 10 |
| ensure | do | clickAndWait | on | css=button.btn.btn-primary |
