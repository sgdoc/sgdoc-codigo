 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste057AlterarPessoaFisicaCPFNaoInformadoCadastro extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste057AlterarPessoaFisicaCPFNaoInformadoCadastro");
