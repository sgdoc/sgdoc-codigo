 ...
 */
class ManterPessoaFisicaSgdoceSuite1CadastrarPessoaFisica7CadastroDocumentosTituloEleitor extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "7CadastroDocumentosTituloEleitor");
...
| ensure | do | select | on | id=sqTipoDocumento | with | label=Título Eleitoral |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[2]/label/following-sibling::div/input[3]-! | with | 1111111 |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[5]/label/following-sibling::div/input[3]-! | with | 99 |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[6]/label/following-sibling::div/input[3]-! | with | 999 |
