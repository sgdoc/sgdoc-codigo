 ...
 */
class ManterTipoDePrioridadeSuite3AlterarTipoPrioridadeCasoTeste006AlterarTipoPrioridadeComDuplicidade extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste006AlterarTipoPrioridadeComDuplicidade");
...
| $txTipoPrioridade_alter= | is | storeExpression | on | Teste CTIS |
| $sqPrioridade_alter= | is | storeExpression | on | 1 |
...
| ensure | do | type | on | id=txTipoPrioridade | with | $txTipoPrioridade_alter |
| ensure | do | type | on | id=sqPrioridade | with | $sqPrioridade_alter |
| ensure | do | clickAndWait | on | css=button.btn.btn-primary |
| check | is | assertText | on | css=div.alert.alert-error | × Tipo de prioridade já cadastrado. |
| stop browser |
');
