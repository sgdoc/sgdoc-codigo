 ...
 */
class ManterMinutaEletronicaSuite3EncaminharMinutaCasoTeste001EncaminharMinutaParaAnalise extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste001EncaminharMinutaParaAnalise");
