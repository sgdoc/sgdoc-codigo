 ...
 */
class ManterModeloDeMinutaSuite1PesquisarModeloMinutaCasoTeste004PesquisarModeloMinuta extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste004PesquisarModeloMinuta");
