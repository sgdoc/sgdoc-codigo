 ...
 */
class VisualizarCaixaDeMinutasSuite2CaixasMinutasEnviadasCasoTeste011CaixaMinutasEnviadasRealizarAcoesMultiplas extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste011CaixaMinutasEnviadasRealizarAcoesMultiplas");
