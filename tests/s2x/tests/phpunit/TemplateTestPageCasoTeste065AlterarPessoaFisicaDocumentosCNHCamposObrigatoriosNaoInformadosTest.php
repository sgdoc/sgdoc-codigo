 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste065AlterarPessoaFisicaDocumentosCNHCamposObrigatoriosNaoInformados extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste065AlterarPessoaFisicaDocumentosCNHCamposObrigatoriosNaoInformados");
...
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[14]/label/following-sibling::div/input[4]-! |
| ensure | do | select | on | !-//form[@id="form-documento-modal"]/fieldset/div[15]/label/following-sibling::div/select-! | with | label=Selecione |
