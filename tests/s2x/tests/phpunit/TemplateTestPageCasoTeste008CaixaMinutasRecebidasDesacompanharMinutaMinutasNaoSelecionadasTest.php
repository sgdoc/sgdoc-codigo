 ...
 */
class VisualizarCaixaDeMinutasSuite1CaixasMinutasRecebidasCasoTeste008CaixaMinutasRecebidasDesacompanharMinutaMinutasNaoSelecionadas extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste008CaixaMinutasRecebidasDesacompanharMinutaMinutasNaoSelecionadas");
