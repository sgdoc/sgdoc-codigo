 ...
 */
class ManterPessoaJuridicaSgdoceSuite2CadastrarPessoaJuridicaCasoTeste011CadastrarPessoaJuridicaExtensaoArquivoInvalida extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste011CadastrarPessoaJuridicaExtensaoArquivoInvalida");
...
| ensure | do | click | on | css=a.btn.btnCancelarEndereco |
| do | close | on |  |
| stop browser |
');
