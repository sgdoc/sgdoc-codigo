 ...
 */
class ManterPessoaFisicaSgdoceSuite1CadastrarPessoaFisica5CadastroDocumentosCarteiraProfissional extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "5CadastroDocumentosCarteiraProfissional");
...
| ensure | do | select | on | id=sqTipoDocumento | with | label=Carteira de Trabalho |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[12]/label/following-sibling::div/input[3]-! | with | 1111111 |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[13]/label/following-sibling::div/input[3]-! | with | 999 |
