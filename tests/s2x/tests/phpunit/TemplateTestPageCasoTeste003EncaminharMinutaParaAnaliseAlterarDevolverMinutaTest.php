 ...
 */
class ManterMinutaEletronicaSuite3EncaminharMinutaCasoTeste003EncaminharMinutaParaAnaliseAlterarDevolverMinuta extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste003EncaminharMinutaParaAnaliseAlterarDevolverMinuta");
