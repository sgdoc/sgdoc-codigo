 ...
 */
class ManterPessoaJuridicaSgdoceSuite2CadastrarPessoaJuridicaCasoTeste005CadastrarPessoaJuridicaCNPJExistente extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste005CadastrarPessoaJuridicaCNPJExistente");
...
| ensure | do | click | on | css=#modalCnpj &gt; div.modal-footer &gt; a.btn &gt; i.icon-remove |
| ensure | do | type | on | id=noPessoa | with | Nova empresa $nmPessoaJuridica |
| do | fireEvent | on | id=noPessoa | with | blur |
| ensure | do | select | on | id=sqNaturezaJuridica | with | label=Sociedade Empresária Limitada |
| ensure | do | type | on | id=noFantasia | with | Fantasia de Nova empresa $nmPessoaJuridica |
