 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste072AlterarPessoaFisicaDocumentosRGCamposObrigatoriosNaoInformados extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste072AlterarPessoaFisicaDocumentosRGCamposObrigatoriosNaoInformados");
...
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[21]/label/following-sibling::div/input[4]-! |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[22]/label/following-sibling::div/input[4]-! |
| ensure | do | select | on | !-//form[@id="form-documento-modal"]/fieldset/div[23]/label/following-sibling::div/select-! | with | label=Selecione |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[24]/label/following-sibling::div/div/input-! |
