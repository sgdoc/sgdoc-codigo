 ...
 */
class ManterModeloDeMinutaSuite2ModeloMinutaPadraoOficioCasoTeste007ModeloMinutaPadraoOficioIncluirCadastroJaRealizado extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste007ModeloMinutaPadraoOficioIncluirCadastroJaRealizado");
