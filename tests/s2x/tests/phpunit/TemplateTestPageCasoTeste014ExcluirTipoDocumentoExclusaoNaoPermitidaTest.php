 ...
 */
class ManterTipoDeDocumentoSuite4ExcluirTipoDocumentoCasoTeste014ExcluirTipoDocumentoExclusaoNaoPermitida extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste014ExcluirTipoDocumentoExclusaoNaoPermitida");
...
| ensure | do | waitForText | on | css=div.alert | with | × Exclusão não permitida. Tipo de documento já utilizado. |
| stop browser |
');
