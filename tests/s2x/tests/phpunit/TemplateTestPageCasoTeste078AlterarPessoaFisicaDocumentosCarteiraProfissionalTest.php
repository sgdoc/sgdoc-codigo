 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste078AlterarPessoaFisicaDocumentosCarteiraProfissional extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste078AlterarPessoaFisicaDocumentosCarteiraProfissional");
...
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[12]/label/following-sibling::div/input[4]-! | with | 121212121212 |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[13]/label/following-sibling::div/input[4]-! | with | 8888 |
