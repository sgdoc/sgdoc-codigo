 ...
 */
class ManterModeloDeMinutaSuite2ModeloMinutaPadraoOficioCasoTeste002ModeloMinutaPadraoOficioIncluirObrigatoriedade extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste002ModeloMinutaPadraoOficioIncluirObrigatoriedade");
