 ...
 */
class ManterPessoaJuridicaSgdoceSuite3AlterarPessoaJuridicaCasoTeste023AlterarPessoaJuridicaExtensaoArquivoInvalida extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste023AlterarPessoaJuridicaExtensaoArquivoInvalida");
