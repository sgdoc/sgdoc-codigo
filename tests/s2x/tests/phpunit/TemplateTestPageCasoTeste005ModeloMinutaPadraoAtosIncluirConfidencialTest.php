 ...
 */
class ManterModeloDeMinutaSuite3ModeloMinutaPadraoAtosCasoTeste005ModeloMinutaPadraoAtosIncluirConfidencial extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste005ModeloMinutaPadraoAtosIncluirConfidencial");
