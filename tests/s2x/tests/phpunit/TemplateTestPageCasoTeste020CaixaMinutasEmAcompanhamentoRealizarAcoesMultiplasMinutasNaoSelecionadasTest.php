 ...
 */
class VisualizarCaixaDeMinutasSuite3CaixasMinutasEmAcompanhamentoCasoTeste020CaixaMinutasEmAcompanhamentoRealizarAcoesMultiplasMinutasNaoSelecionadas extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste020CaixaMinutasEmAcompanhamentoRealizarAcoesMultiplasMinutasNaoSelecionadas");
