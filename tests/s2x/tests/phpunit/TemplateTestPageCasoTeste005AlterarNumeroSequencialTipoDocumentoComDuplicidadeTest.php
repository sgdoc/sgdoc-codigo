 ...
 */
class CadastrarSequencialDeUnidadeOrganizacionalSuite2AlterarNumeroSequencialCasoTeste005AlterarNumeroSequencialTipoDocumentoComDuplicidade extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste005AlterarNumeroSequencialTipoDocumentoComDuplicidade");
...
| $nmTipoDocumento2= | is | storeExpression | on | APOLICE |
...
| ensure | do | selectAndWait | on | id=sqTipoDocumento | with | label=$nmTipoDocumento2 |
| ensure | do | type | on | id=nuSequencial | with | 2 |
| ensure | do | clickAndWait | on | css=button.btn.btn-primary |
| ensure | do | waitForText | on | css=div.alert.alert-error | with | × Número já cadastrado. |
| stop browser |
');
