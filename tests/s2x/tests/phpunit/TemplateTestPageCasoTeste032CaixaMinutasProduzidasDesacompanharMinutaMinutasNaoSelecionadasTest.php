 ...
 */
class VisualizarCaixaDeMinutasSuite4CaixasMinutasProduzidasCasoTeste032CaixaMinutasProduzidasDesacompanharMinutaMinutasNaoSelecionadas extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste032CaixaMinutasProduzidasDesacompanharMinutaMinutasNaoSelecionadas");
