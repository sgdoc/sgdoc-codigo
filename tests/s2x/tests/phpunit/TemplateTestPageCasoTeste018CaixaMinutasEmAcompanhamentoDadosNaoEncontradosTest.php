 ...
 */
class VisualizarCaixaDeMinutasSuite3CaixasMinutasEmAcompanhamentoCasoTeste018CaixaMinutasEmAcompanhamentoDadosNaoEncontrados extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste018CaixaMinutasEmAcompanhamentoDadosNaoEncontrados");
...
| check | is | assertText | on | css=td.dataTables_empty | Não há minutas na sua caixa em acompanhamento |
| stop browser |
');
