 ...
 */
class VisualizarCaixaDeMinutasSuite3CaixasMinutasEmAcompanhamentoCasoTeste021CaixaMinutasEmAcompanhamentoAcompanharMinuta extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste021CaixaMinutasEmAcompanhamentoAcompanharMinuta");
