 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste105AlterarPessoaFisicaContatoTelefone extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste105AlterarPessoaFisicaContatoTelefone");
...
| ensure | do | click | on | !-//*[@id="table-telefone"]/tbody/tr/td[contains(.,"Residencial")]/../td[4]/a[@title="Alterar"]-! | with | Residencial |
| ensure | do | type | on | id=nuDdd | with | 011 |
| ensure | do | type | on | id=nuTelefone | with | 11111-1111 |
...
| ensure | do | assertElementNotPresent | on | css=#sqTipoTelefone &gt; option[value=&quot;1&quot;] |
