 ...
 */
class VisualizarCaixaDeMinutasSuite3CaixasMinutasEmAcompanhamentoCasoTeste024CaixaMinutasEmAcompanhamentoDesacompanharMinutaMinutasNaoSelecionadas extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste024CaixaMinutasEmAcompanhamentoDesacompanharMinutaMinutasNaoSelecionadas");
