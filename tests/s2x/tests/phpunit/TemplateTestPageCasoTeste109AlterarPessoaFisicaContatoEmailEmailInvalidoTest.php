 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste109AlterarPessoaFisicaContatoEmailEmailInvalido extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste109AlterarPessoaFisicaContatoEmailEmailInvalido");
...
| ensure | do | type | on | id=txEmail | with | !-teste@teste-! |
