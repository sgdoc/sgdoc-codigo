 ...
 */
class VisualizarCaixaDeMinutasSuite2CaixasMinutasEnviadasCasoTeste010CaixaMinutasEnviadasDadosNaoEncontrados extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        $this->open("/ProjectSgdoc.VisualizarCaixaDeMinutas.Suite2CaixasMinutasEnviadas");
        $this->click("link=Add");
        $this->click("link=Test page");
        $this->waitForPageToLoad("30000");
        $this->type("id=pagename", "CasoTeste010CaixaMinutasEnviadasDadosNaoEncontrados");
...
| ensure | do | clickAndWait | on | link=Enviadas |
| ensure | do | waitForElementPresent | on | css=td.dataTables_empty |
| check | is | assertText | on | css=td.dataTables_empty | Não há minutas na sua caixa enviadas |
| stop browser |
');
