 ...
 */
class ManterPessoaJuridicaSgdoceSuite4ExcluirDadosPessoaJuridicaCasoTeste031ExcluirDadosPessoaJuridicaExcluirEndereco extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste031ExcluirDadosPessoaJuridicaExcluirEndereco");
