 ...
 */
class ManterTipoDeDocumentoSuite5DesativarAtivarTipoDocumentoCasoTeste015DesativarAtivarTipoDocumentoCancelarDesativacao extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste015DesativarAtivarTipoDocumentoCancelarDesativacao");
