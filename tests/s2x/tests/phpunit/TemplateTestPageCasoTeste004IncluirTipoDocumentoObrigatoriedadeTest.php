 ...
 */
class ManterTipoDeDocumentoSuite2IncluirTipoDocumentoCasoTeste004IncluirTipoDocumentoObrigatoriedade extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste004IncluirTipoDocumentoObrigatoriedade");
