 ...
 */
class VisualizarCaixaDeMinutasSuite2CaixasMinutasEnviadasCasoTeste012CaixaMinutasEnviadasRealizarAcoesMultiplasMinutasNaoSelecionadas extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste012CaixaMinutasEnviadasRealizarAcoesMultiplasMinutasNaoSelecionadas");
