 ...
 */
class ManterMensagemSuite4AtivarDesativarMensagemCasoTeste011AtivarDesativarMensagemAtivar extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste011AtivarDesativarMensagemAtivar");
...
| ensure | do | waitForText | on | !-//table[@id="table-grid"]/tbody/tr/td[5]/a[3]/span-! | with | Ativar |
| ensure | do | click | on | !-//table[@id="table-grid"]/tbody/tr/td[5]/a[3]/span-! |
| ensure | do | waitForText | on | css=p | with | Mensagem ativada com Sucesso |
