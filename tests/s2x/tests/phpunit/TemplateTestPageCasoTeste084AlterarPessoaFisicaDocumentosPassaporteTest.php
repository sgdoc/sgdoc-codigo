 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste084AlterarPessoaFisicaDocumentosPassaporte extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste084AlterarPessoaFisicaDocumentosPassaporte");
...
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[25]/label/following-sibling::div/input[4]-! | with | 99887766554433221100 |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[26]/label/following-sibling::div/input[4]-! | with | USA |
