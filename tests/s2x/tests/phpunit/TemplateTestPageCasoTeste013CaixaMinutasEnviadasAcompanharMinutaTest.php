 ...
 */
class VisualizarCaixaDeMinutasSuite2CaixasMinutasEnviadasCasoTeste013CaixaMinutasEnviadasAcompanharMinuta extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste013CaixaMinutasEnviadasAcompanharMinuta");
