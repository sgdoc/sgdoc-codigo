 ...
 */
class ManterTipoDePrioridadeSuite2IncluirTipoPrioridadeCasoTeste003IncluirTipoPrioridade extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste003IncluirTipoPrioridade");
...
| ensure | do | waitForText | on | css=div.alert-success | with | × Inclusão realizada com sucesso. |
| stop browser |
');
