 ...
 */
class ManterModeloDeMinutaSuite3ModeloMinutaPadraoAtosCasoTeste010ModeloMinutaPadraoAtosAlterarSigilosoParaConfidencial extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        $this->open("/ProjectSgdoc.ManterModeloDeMinuta.Suite3ModeloMinutaPadraoAtos");
        $this->click("link=Add");
        $this->click("link=Test page");
        $this->waitForPageToLoad("30000");
        $this->type("id=pagename", "CasoTeste010ModeloMinutaPadraoAtosAlterarSigilosoParaConfidencial");
