 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste091AlterarPessoaFisicaDocumentosTituloEleitorCamposObrigatoriosNaoInformados extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste091AlterarPessoaFisicaDocumentosTituloEleitorCamposObrigatoriosNaoInformados");
...
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[2]/label/following-sibling::div/input[4]-! |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[5]/label/following-sibling::div/input[4]-! |
