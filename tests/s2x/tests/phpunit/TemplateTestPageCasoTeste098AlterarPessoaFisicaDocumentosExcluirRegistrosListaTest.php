 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste098AlterarPessoaFisicaDocumentosExcluirRegistrosLista extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste098AlterarPessoaFisicaDocumentosExcluirRegistrosLista");
...
| ensure | do | click | on | !-//*[@id="table-documento"]/tbody/tr/td[contains(.,"Título Eleitoral")]/../td[4]/div/button-! | with | Título Eleitoral |
| ensure | do | click | on | xpath=(//a[contains(text(),"Excluir registro")]) |
| check | is | verifyText | on | //body/div[6]/div[2] | Tem certeza que deseja realizar a exclusão? |
| ensure | do | click | on | xpath=(//a[contains(text(),"Sim")])[3] |
| ensure | do | waitForText | on | //body/div[6]/div[2] | with | exact:Exclusão realizada com sucesso. |
| do | close | on |  |
| stop browser |
');
