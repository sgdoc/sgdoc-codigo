 ...
 */
class ManterPessoaJuridicaSgdoceSuite3AlterarPessoaJuridicaCasoTeste020AlterarPessoaJuridicaCEPNaoEncontrado extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste020AlterarPessoaJuridicaCEPNaoEncontrado");
