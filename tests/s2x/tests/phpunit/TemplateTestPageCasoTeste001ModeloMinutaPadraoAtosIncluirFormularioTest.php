 ...
 */
class ManterModeloDeMinutaSuite3ModeloMinutaPadraoAtosCasoTeste001ModeloMinutaPadraoAtosIncluirFormulario extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste001ModeloMinutaPadraoAtosIncluirFormulario");
