 ...
 */
class ManterModeloDeMinutaSuite3ModeloMinutaPadraoAtosCasoTeste008ModeloMinutaPadraoAtosAlterarObrigatoriedade extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste008ModeloMinutaPadraoAtosAlterarObrigatoriedade");
