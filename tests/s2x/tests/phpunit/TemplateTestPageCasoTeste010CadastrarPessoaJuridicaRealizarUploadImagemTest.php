 ...
 */
class ManterPessoaJuridicaSgdoceSuite2CadastrarPessoaJuridicaCasoTeste010CadastrarPessoaJuridicaRealizarUploadImagem extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste010CadastrarPessoaJuridicaRealizarUploadImagem");
...
| $nmTipoEndereco= | is | storeExpression | on | Contato |
...
| ensure | do | type | on | id=noContato | with | Contato do joão matuto |
...
| ensure | do | type | on | id=nuEndereco | with | 99 |
| ensure | do | type | on | id=txImagem | with | $path_to_attach\png\Endereco.png |
| ensure | do | click | on | link=Concluir |
| ensure | do | waitForText | on | css=span.help-block.show | with | Upload em andamento. Por favor aguarde. |
| do | close | on |  |
| stop browser |
');
