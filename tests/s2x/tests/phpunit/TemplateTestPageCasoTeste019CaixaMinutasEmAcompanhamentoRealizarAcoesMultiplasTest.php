 ...
 */
class VisualizarCaixaDeMinutasSuite3CaixasMinutasEmAcompanhamentoCasoTeste019CaixaMinutasEmAcompanhamentoRealizarAcoesMultiplas extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        $this->open("/ProjectSgdoc.VisualizarCaixaDeMinutas.Suite3CaixasMinutasEmAcompanhamento");
        $this->click("link=Add");
        $this->click("link=Test page");
        $this->waitForPageToLoad("30000");
        $this->type("id=pagename", "CasoTeste019CaixaMinutasEmAcompanhamentoRealizarAcoesMultiplas");
...
| ensure | do | clickAndWait | on | link=Em Acompanhamento |
| ensure | do | waitForElementNotPresent | on | css=td.dataTables_empty |
| ensure | do | waitForElementPresent | on | name=sqArtefato[] |
| ensure | do | waitForElementPresent | on | document.forms["form-minuta-acoes-multiplas"].elements["sqArtefato[]"][1] |
| ensure | do | click | on | name=sqArtefato[] |
| ensure | do | click | on | document.forms["form-minuta-acoes-multiplas"].elements["sqArtefato[]"][1] |
| ensure | do | click | on | !-//form[@id="form-minuta-acoes-multiplas"]/div/div/button-! |
| ensure | do | click | on | id=acaoMultDesacompMuin |
| ensure | do | waitForElementPresent | on | css=div.modal-body |
| check | is | verifyText | on | //div[5]/div[2] | Tem certeza que deseja desacompanhar a minuta? |
