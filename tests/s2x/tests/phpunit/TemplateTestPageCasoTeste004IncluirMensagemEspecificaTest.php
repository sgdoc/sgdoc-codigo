 ...
 */
class ManterMensagemSuite2IncluirMensagemCasoTeste004IncluirMensagemEspecifica extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste004IncluirMensagemEspecifica");
...
| ensure | do | type | on | id=mensagemEspecifica | with | conteudo de teste da mensagem especifica |
| ensure | do | clickAndWait | on | css=button.btn.btn-primary |
