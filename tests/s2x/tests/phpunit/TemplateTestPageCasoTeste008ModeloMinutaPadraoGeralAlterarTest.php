 ...
 */
class ManterModeloDeMinutaSuite4ModeloMinutaPadraoGeralCasoTeste008ModeloMinutaPadraoGeralAlterar extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste008ModeloMinutaPadraoGeralAlterar");
