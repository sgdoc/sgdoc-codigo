 ...
 */
class ManterPessoaJuridicaSgdoceSuite4ExcluirDadosPessoaJuridicaCasoTeste032ExcluirDadosPessoaJuridicaExcluirTelefone extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        $this->open("/ProjectSgdoc.ManterPessoaJuridicaSgdoce.Suite4ExcluirDadosPessoaJuridica");
        $this->click("link=Add");
        $this->click("link=Test page");
        $this->waitForPageToLoad("30000");
        $this->type("id=pagename", "CasoTeste032ExcluirDadosPessoaJuridicaExcluirTelefone");
...
| ensure | do | click | on | !-//*[@id="table-telefone"]/tbody/tr/td[contains(.,"$nmTipoTelefone")]/../td[4]/a[@title="Excluir"]-! | with | $nmTipoTelefone |
| ensure | do | waitForText | on | //body/div[5]/div[2] | with | exact:Tem certeza que deseja realizar a exclusão? |
| ensure | do | click | on | xpath=(//a[contains(text(),"Sim")])[3] |
| ensure | do | waitForText | on | //body/div[5]/div[2]/div | with | Exclusão realizada com sucesso. |
| ensure | do | click | on | xpath=(//a[contains(text(),"Fechar")])[4] |
| ensure | do | assertTextNotPresent | on | !-//*[@id="table-telefone"]/tbody/tr/td[contains(.,"$nmTipoTelefone")]-! |
| do | close | on |  |
| stop browser |
');
