 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste090AlterarPessoaFisicaDocumentosTituloEleitor extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste090AlterarPessoaFisicaDocumentosTituloEleitor");
...
| ensure | do | click | on | !-//*[@id="table-documento"]/tbody/tr/td[contains(.,"Título Eleitoral")]/../td[4]/div/a[@title="Alterar"]-! | with | Título Eleitoral |
| ensure | do | waitForText | on | css=h3.title-main | with | Alterar Documento |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[2]/label/following-sibling::div/input[4]-! | with | 11223344556677889900 |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[5]/label/following-sibling::div/input[4]-! | with | 909090 |
| ensure | do | click | on | xpath=(//a[contains(text(),"Concluir")])[2] |
| ensure | do | waitForText | on | //div[14]/div[2]/div | with | Operação realizada com sucesso |
