 ...
 */
class ManterTipoDePrioridadeSuite4ExcluirTipoPrioridadeCasoTeste008ExclusaoTipoPrioridadeConfirmar extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste008ExclusaoTipoPrioridadeConfirmar");
...
| $sqPrioridade_search= | is | storeExpression | on | 2 |
