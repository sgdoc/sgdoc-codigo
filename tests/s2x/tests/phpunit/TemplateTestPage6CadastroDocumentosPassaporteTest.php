 ...
 */
class ManterPessoaFisicaSgdoceSuite1CadastrarPessoaFisica6CadastroDocumentosPassaporte extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "6CadastroDocumentosPassaporte");
...
| ensure | do | select | on | id=sqTipoDocumento | with | label=Passaporte |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[25]/label/following-sibling::div/input[3]-! | with | 1111111 |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[26]/label/following-sibling::div/input[3]-! | with | Italiana |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[27]/label/following-sibling::div/div/input-! | with | 01/01/2001 |
