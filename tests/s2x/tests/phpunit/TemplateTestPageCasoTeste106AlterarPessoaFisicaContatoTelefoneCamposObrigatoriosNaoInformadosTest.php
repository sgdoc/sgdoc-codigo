 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste106AlterarPessoaFisicaContatoTelefoneCamposObrigatoriosNaoInformados extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste106AlterarPessoaFisicaContatoTelefoneCamposObrigatoriosNaoInformados");
...
| ensure | do | type | on | id=nuDdd |
| ensure | do | type | on | id=nuTelefone |
