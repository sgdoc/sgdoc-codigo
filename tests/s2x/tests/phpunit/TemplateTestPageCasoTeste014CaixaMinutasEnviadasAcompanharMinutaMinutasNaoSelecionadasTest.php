 ...
 */
class VisualizarCaixaDeMinutasSuite2CaixasMinutasEnviadasCasoTeste014CaixaMinutasEnviadasAcompanharMinutaMinutasNaoSelecionadas extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste014CaixaMinutasEnviadasAcompanharMinutaMinutasNaoSelecionadas");
