 ...
 */
class ManterModeloDeCarimboSuite2IncluirModeloCarimboCasoTeste004IncluirModeloCarimboTamanhoArquivo extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste004IncluirModeloCarimboTamanhoArquivo");
...
| ensure | do | type | on | name=deCaminhoArquivo | with | $path_to_attach\png\larger_100MB.png |
| ensure | do | click | on | id=sqTipoArtefato |
| ensure | do | select | on | id=sqTipoArtefato | with | label=Despacho |
| ensure | do | clickAndWait | on | css=button.btn.btn-primary |
| check | is | assertText | on | css=div.alert.alert-error | × O tamanho do arquivo é superior ao permitido. O tamanho permitido é 100Mb. |
| stop browser |
');
