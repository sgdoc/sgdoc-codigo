 ...
 */
class ManterModeloDeMinutaSuite3ModeloMinutaPadraoAtosCasoTeste009ModeloMinutaPadraoAtosAlterarPublicoParaSigiloso extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste009ModeloMinutaPadraoAtosAlterarPublicoParaSigiloso");
