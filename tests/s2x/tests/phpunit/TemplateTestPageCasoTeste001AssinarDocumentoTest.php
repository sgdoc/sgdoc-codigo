 ...
 */
class ManterMinutaEletronicaSuite2AssinarDocumentoCasoTeste001AssinarDocumento extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste001AssinarDocumento");
