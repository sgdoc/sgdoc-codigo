 ...
 */
class ManterMinutaEletronicaSuite2AssinarDocumentoCasoTeste004AssinarDocumentoAssinaturaInvalida extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste004AssinarDocumentoAssinaturaInvalida");
