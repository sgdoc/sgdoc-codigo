 ...
 */
class ManterTipoDeDocumentoSuite5DesativarAtivarTipoDocumentoCasoTeste016DesativarAtivarTipoDocumentoConfirmarDesativacao extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        $this->open("/ProjectSgdoc.ManterTipoDeDocumento.Suite5DesativarAtivarTipoDocumento");
        $this->click("link=Add");
        $this->click("link=Test page");
        $this->waitForPageToLoad("30000");
        $this->type("id=pagename", "CasoTeste016DesativarAtivarTipoDocumentoConfirmarDesativacao");
...
| ensure | do | waitForElementPresent | on | !-//table[@id="table-grid"]/tbody/tr/td[4]/a[3]/span-! |
| ensure | do | click | on | !-//table[@id="table-grid"]/tbody/tr/td[4]/a[3]/span-! |
| ensure | do | waitForText | on | css=div.modal-body | with | exact:Tem certeza que deseja desativar o Tipo de Documento? |
| ensure | do | click | on | link=Sim |
| ensure | do | waitForText | on | css=p | with | Tipo de Documento desativado. |
