 ...
 */
class ManterModeloDeMinutaSuite4ModeloMinutaPadraoGeralCasoTeste002ModeloMinutaPadraoGeralIncluirObrigatoriedade extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste002ModeloMinutaPadraoGeralIncluirObrigatoriedade");
