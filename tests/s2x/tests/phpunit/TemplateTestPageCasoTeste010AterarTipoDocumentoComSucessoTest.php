 ...
 */
class ManterTipoDeDocumentoSuite3AlterarTipoDocumentoCasoTeste010AterarTipoDocumentoComSucesso extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste010AterarTipoDocumentoComSucesso");
...
| ensure | do | click | on | id=inAbreProcesso-0 |
| ensure | do | clickAndWait | on | css=button.btn.btn-primary |
