 ...
 */
class VisualizarCaixaDeMinutasSuite4CaixasMinutasProduzidasCasoTeste030CaixaMinutasProduzidasAcompanharMinutaMinutasNaoSelecionadas extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste030CaixaMinutasProduzidasAcompanharMinutaMinutasNaoSelecionadas");
