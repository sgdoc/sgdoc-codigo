 ...
 */
class VisualizarCaixaDeMinutasSuite3CaixasMinutasEmAcompanhamentoCasoTeste022CaixaMinutasEmAcompanhamentoAcompanharMinutaMinutasNaoSelecionadas extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste022CaixaMinutasEmAcompanhamentoAcompanharMinutaMinutasNaoSelecionadas");
