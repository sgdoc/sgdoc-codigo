 ...
 */
class ManterModeloDeMinutaSuite2ModeloMinutaPadraoOficioCasoTeste003ModeloMinutaPadraoOficioIncluirSemGrauAcesso extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste003ModeloMinutaPadraoOficioIncluirSemGrauAcesso");
