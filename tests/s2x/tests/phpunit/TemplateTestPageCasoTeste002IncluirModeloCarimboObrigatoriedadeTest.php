 ...
 */
class ManterModeloDeCarimboSuite2IncluirModeloCarimboCasoTeste002IncluirModeloCarimboObrigatoriedade extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste002IncluirModeloCarimboObrigatoriedade");
...
| check | is | assertText | on | css=p.help-block | Campo de preenchimento obrigatório. |
| ensure | do | type | on | id=noCarimbo | with | $noCarimbo_new |
| ensure | do | click | on | css=button.btn.btn-primary |
| check | is | assertText | on | !-//form[@id="form-carimbo"]/fieldset/div[2]/div/p-! | Campo de preenchimento obrigatório. |
