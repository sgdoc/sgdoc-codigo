 ...
 */
class VisualizarCaixaDeMinutasSuite1CaixasMinutasRecebidasCasoTeste007CaixaMinutasRecebidasDesacompanharMinuta extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste007CaixaMinutasRecebidasDesacompanharMinuta");
