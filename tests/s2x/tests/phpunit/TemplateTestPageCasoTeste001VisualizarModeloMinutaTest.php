 ...
 */
class ManterModeloDeMinutaSuite5VisualizarModeloMinutaCasoTeste001VisualizarModeloMinuta extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        $this->open("/ProjectSgdoc.ManterModeloDeMinuta.Suite5VisualizarModeloMinuta");
        $this->click("link=Add");
        $this->click("link=Test page");
        $this->waitForPageToLoad("30000");
        $this->type("id=pagename", "CasoTeste001VisualizarModeloMinuta");
