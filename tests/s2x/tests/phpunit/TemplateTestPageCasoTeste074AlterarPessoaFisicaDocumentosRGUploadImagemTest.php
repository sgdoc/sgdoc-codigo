 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste074AlterarPessoaFisicaDocumentosRGUploadImagem extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste074AlterarPessoaFisicaDocumentosRGUploadImagem");
...
| ensure | do | type | on | id=txImagem | with | $path_to_attach\png\RG.png |
