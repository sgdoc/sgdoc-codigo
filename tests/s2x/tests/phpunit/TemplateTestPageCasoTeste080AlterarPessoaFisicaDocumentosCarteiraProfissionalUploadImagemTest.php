 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste080AlterarPessoaFisicaDocumentosCarteiraProfissionalUploadImagem extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste080AlterarPessoaFisicaDocumentosCarteiraProfissionalUploadImagem");
...
| ensure | do | type | on | id=txImagem | with | $path_to_attach\png\CTPS.png |
| ensure | do | clickAndWait | on | xpath=(//a[contains(text(),"Concluir")])[2] |
| check | is | verifyText | on | css=span.help-block.show | Upload em andamento. Por favor aguarde. |
| do | close | on |  |
| stop browser |
');
