 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste097AlterarPessoaFisicaDocumentosExcluirImagemInserida extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste097AlterarPessoaFisicaDocumentosExcluirImagemInserida");
