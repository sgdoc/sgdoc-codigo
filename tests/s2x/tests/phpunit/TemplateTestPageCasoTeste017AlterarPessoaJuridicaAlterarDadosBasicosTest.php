 ...
 */
class ManterPessoaJuridicaSgdoceSuite3AlterarPessoaJuridicaCasoTeste017AlterarPessoaJuridicaAlterarDadosBasicos extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste017AlterarPessoaJuridicaAlterarDadosBasicos");
...
| $nmFantasiaPessoaJuridica= | is | storeExpression | on | Fantasia de João Matutoto Ltda |
...
| ensure | do | type | on | id=noFantasia | with | $nmFantasiaPessoaJuridica |
| ensure | do | click | on | link=Concluir |
| ensure | do | waitForText | on | css=fieldset &gt; p | with | Alteração realizada com sucesso. |
