 ...
 */
class VincularPrazoSuite4ExcluirVinculacaoPrazoCasoTeste008ExcluirVinculacaoPrazo extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste008ExcluirVinculacaoPrazo");
