 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste066AlterarPessoaFisicaDocumentosCNHDataInvalida extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste066AlterarPessoaFisicaDocumentosCNHDataInvalida");
...
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[16]/label/following-sibling::div/div/input-! | with | 00/00/0000 |
| ensure | do | click | on | xpath=(//a[contains(text(),"Concluir")])[2] |
| check | is | verifyText | on | css=p.help-block | Data inválida. |
