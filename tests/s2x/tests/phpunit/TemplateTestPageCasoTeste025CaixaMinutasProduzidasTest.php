 ...
 */
class VisualizarCaixaDeMinutasSuite4CaixasMinutasProduzidasCasoTeste025CaixaMinutasProduzidas extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste025CaixaMinutasProduzidas");
