 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste079AlterarPessoaFisicaDocumentosCarteiraProfissionalCamposObrigatoriosNaoInformados extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste079AlterarPessoaFisicaDocumentosCarteiraProfissionalCamposObrigatoriosNaoInformados");
...
| ensure | do | click | on | !-//*[@id="table-documento"]/tbody/tr/td[contains(.,"Carteira de Trabalho")]/../td[4]/div/a[@title="Alterar"]-! | with | Carteira de Trabalho |
| ensure | do | waitForText | on | css=h3.title-main | with | Alterar Documento |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[12]/label/following-sibling::div/input[4]-! |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[13]/label/following-sibling::div/input[4]-! |
