 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste086AlterarPessoaFisicaDocumentosPassaporteUploadImagem extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste086AlterarPessoaFisicaDocumentosPassaporteUploadImagem");
...
| ensure | do | type | on | id=txImagem | with | $path_to_attach\png\Passaporte.png |
