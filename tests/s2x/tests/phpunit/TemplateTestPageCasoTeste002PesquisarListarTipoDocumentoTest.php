 ...
 */
class ManterTipoDeDocumentoSuite1PesquisarListarTipoDocumentoCasoTeste002PesquisarListarTipoDocumento extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste002PesquisarListarTipoDocumento");
...
| ensure | do | waitForText | on | css=td..sorting_1 | with | javascript{storedVars[&quot;nmTipoDocumento&quot;].toUpperCase()} |
| stop browser |
');
