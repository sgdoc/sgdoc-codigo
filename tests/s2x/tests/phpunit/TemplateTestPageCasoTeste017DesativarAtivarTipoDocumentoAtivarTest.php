 ...
 */
class ManterTipoDeDocumentoSuite5DesativarAtivarTipoDocumentoCasoTeste017DesativarAtivarTipoDocumentoAtivar extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste017DesativarAtivarTipoDocumentoAtivar");
...
| ensure | do | waitForText | on | css=p | with | Tipo de Documento ativado com Sucesso |
