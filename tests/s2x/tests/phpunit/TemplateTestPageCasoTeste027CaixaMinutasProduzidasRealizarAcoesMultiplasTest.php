 ...
 */
class VisualizarCaixaDeMinutasSuite4CaixasMinutasProduzidasCasoTeste027CaixaMinutasProduzidasRealizarAcoesMultiplas extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste027CaixaMinutasProduzidasRealizarAcoesMultiplas");
...
| ensure | do | clickAndWait | on | id=acaoMultAcompMin |
| stop browser |
');
