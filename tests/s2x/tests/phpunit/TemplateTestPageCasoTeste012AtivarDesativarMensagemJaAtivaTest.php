 ...
 */
class ManterMensagemSuite4AtivarDesativarMensagemCasoTeste012AtivarDesativarMensagemJaAtiva extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste012AtivarDesativarMensagemJaAtiva");
