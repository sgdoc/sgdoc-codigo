 ...
 */
class ManterModeloDeMinutaSuite3ModeloMinutaPadraoAtosCasoTeste007ModeloMinutaPadraoAtosIncluirCadastroJaRealizado extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste007ModeloMinutaPadraoAtosIncluirCadastroJaRealizado");
