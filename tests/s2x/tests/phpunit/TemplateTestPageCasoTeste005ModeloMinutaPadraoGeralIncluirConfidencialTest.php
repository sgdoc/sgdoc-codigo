 ...
 */
class ManterModeloDeMinutaSuite4ModeloMinutaPadraoGeralCasoTeste005ModeloMinutaPadraoGeralIncluirConfidencial extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste005ModeloMinutaPadraoGeralIncluirConfidencial");
