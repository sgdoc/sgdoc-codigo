 ...
 */
class ManterMinutaEletronicaSuite1CadastrarMinutaEletronicaCasoTeste010CadastrarMinutaEletronicaInteressadoExternoOutrosOrgaos extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste010CadastrarMinutaEletronicaInteressadoExternoOutrosOrgaos");
