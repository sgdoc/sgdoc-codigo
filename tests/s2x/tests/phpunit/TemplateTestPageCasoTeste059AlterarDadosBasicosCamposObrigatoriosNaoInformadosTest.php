 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste059AlterarDadosBasicosCamposObrigatoriosNaoInformados extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste059AlterarDadosBasicosCamposObrigatoriosNaoInformados");
...
| ensure | do | type | on | id=noPessoaFisica |
| ensure | do | click | on | link=Próxima |
| check | is | verifyText | on | id=body-error | × Campos de preenchimento obrigatório não foram preenchidos. |
| do | close | on |  |
| stop browser |
');
