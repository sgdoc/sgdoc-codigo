 ...
 */
class ManterModeloDeMinutaSuite1PesquisarModeloMinutaCasoTeste002PesquisarModeloMinutaNenhumResultadoEncontrado extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste002PesquisarModeloMinutaNenhumResultadoEncontrado");
