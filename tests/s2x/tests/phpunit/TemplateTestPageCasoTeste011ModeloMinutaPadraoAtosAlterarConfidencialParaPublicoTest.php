 ...
 */
class ManterModeloDeMinutaSuite3ModeloMinutaPadraoAtosCasoTeste011ModeloMinutaPadraoAtosAlterarConfidencialParaPublico extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste011ModeloMinutaPadraoAtosAlterarConfidencialParaPublico");
