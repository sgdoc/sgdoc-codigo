 ...
 */
class VisualizarCaixaDeMinutasSuite1CaixasMinutasRecebidasCasoTeste006CaixaMinutasRecebidasAcompanharMinutaMinutasNaoSelecionadas extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste006CaixaMinutasRecebidasAcompanharMinutaMinutasNaoSelecionadas");
