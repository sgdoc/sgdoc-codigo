 ...
 */
class ManterModeloDeMinutaSuite2ModeloMinutaPadraoOficioCasoTeste001ModeloMinutaPadraoOficioIncluirFormulario extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste001ModeloMinutaPadraoOficioIncluirFormulario");
