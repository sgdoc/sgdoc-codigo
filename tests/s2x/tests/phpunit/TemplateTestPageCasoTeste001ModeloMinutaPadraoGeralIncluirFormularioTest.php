 ...
 */
class ManterModeloDeMinutaSuite4ModeloMinutaPadraoGeralCasoTeste001ModeloMinutaPadraoGeralIncluirFormulario extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste001ModeloMinutaPadraoGeralIncluirFormulario");
