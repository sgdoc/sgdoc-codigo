 ...
 */
class ManterTipoDePrioridadeSuite2IncluirTipoPrioridadeCasoTeste002IncluirTipoPrioridadeObrigatoridade extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste002IncluirTipoPrioridadeObrigatoridade");
...
| check | is | assertText | on | !-//form[@id="form-tipo-prioridade"]/fieldset/div[1]/div/p-! | Campo de preenchimento obrigatório. |
| ensure | do | type | on | id=txTipoPrioridade | with | $txTipoPrioridade_save |
| ensure | do | click | on | css=button.btn.btn-primary |
| check | is | assertText | on | !-//form[@id="form-tipo-prioridade"]/fieldset/div[2]/div/p-! | Campo de preenchimento obrigatório. |
| stop browser |
');
