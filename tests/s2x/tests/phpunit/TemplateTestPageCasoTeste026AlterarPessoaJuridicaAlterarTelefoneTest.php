 ...
 */
class ManterPessoaJuridicaSgdoceSuite3AlterarPessoaJuridicaCasoTeste026AlterarPessoaJuridicaAlterarTelefone extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste026AlterarPessoaJuridicaAlterarTelefone");
...
| $nuTelefone= | is | storeExpression | on | 3012-0000 |
