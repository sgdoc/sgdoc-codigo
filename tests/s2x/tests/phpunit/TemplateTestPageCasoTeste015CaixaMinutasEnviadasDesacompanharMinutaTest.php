 ...
 */
class VisualizarCaixaDeMinutasSuite2CaixasMinutasEnviadasCasoTeste015CaixaMinutasEnviadasDesacompanharMinuta extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste015CaixaMinutasEnviadasDesacompanharMinuta");
