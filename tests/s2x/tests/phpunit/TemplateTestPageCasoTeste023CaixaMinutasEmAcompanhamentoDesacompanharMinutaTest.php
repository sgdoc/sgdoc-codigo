 ...
 */
class VisualizarCaixaDeMinutasSuite3CaixasMinutasEmAcompanhamentoCasoTeste023CaixaMinutasEmAcompanhamentoDesacompanharMinuta extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste023CaixaMinutasEmAcompanhamentoDesacompanharMinuta");
...
| ensure | do | waitForText | on | css=div.alert.alert-success | with | × Operação realizada com sucesso |
| stop browser |
');
