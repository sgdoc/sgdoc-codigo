 ...
 */
class ManterMinutaEletronicaSuite1CadastrarMinutaEletronicaCasoTeste006CadastrarMinutaEletronicaInteressadoExternoPessoaFisica extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste006CadastrarMinutaEletronicaInteressadoExternoPessoaFisica");
