 ...
 */
class ManterMinutaEletronicaSuite3EncaminharMinutaCasoTeste002EncaminharMinutaParaAnaliseAlterarMinuta extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste002EncaminharMinutaParaAnaliseAlterarMinuta");
