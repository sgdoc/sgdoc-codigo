 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste085AlterarPessoaFisicaDocumentosPassaporteCamposObrigatoriosNaoInformados extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste085AlterarPessoaFisicaDocumentosPassaporteCamposObrigatoriosNaoInformados");
...
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[25]/label/following-sibling::div/input[4]-! |
| ensure | do | type | on | !-//form[@id="form-documento-modal"]/fieldset/div[26]/label/following-sibling::div/input[4]-! |
