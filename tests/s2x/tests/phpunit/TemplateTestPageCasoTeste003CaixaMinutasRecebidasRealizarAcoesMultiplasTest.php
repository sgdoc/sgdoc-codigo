 ...
 */
class VisualizarCaixaDeMinutasSuite1CaixasMinutasRecebidasCasoTeste003CaixaMinutasRecebidasRealizarAcoesMultiplas extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste003CaixaMinutasRecebidasRealizarAcoesMultiplas");
