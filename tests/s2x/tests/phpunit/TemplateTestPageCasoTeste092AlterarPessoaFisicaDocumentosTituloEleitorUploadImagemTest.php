 ...
 */
class ManterPessoaFisicaSgdoceSuite3AlterarPessoaFisicaCasoTeste092AlterarPessoaFisicaDocumentosTituloEleitorUploadImagem extends PHPUnit_Extensions_SeleniumTestCase {
    ...
    public function testMyTestCase() {
        ...
        $this->type("id=pagename", "CasoTeste092AlterarPessoaFisicaDocumentosTituloEleitorUploadImagem");
...
| ensure | do | type | on | id=txImagem | with | $path_to_attach\png\TituloEleitor.png |
