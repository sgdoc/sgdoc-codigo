...
function HandleFatalError() {
    ...
    if ( !is_null($error) && (
        ...
        //Se for produção ICMBIO/PRESIDÊNCIA envia e-mail, senão mostra em tela
        $prdID = 'prd';
        if( strpos( strtolower(CF_APP_ENVIRONMENT), $prdID ) !== false ){
...
/**
 * Forçar o nome da sessão para integração com o SGDoc-E
 */
session_name('sisicmbio');
 ...
 * Controlador Central 
 */
Controlador::getInstance()->dispatch();