<?php
/**
 * File for class QualitativoStructObterFinanciamentoExtraOrcamentarioPorIniciativa
 * @package Qualitativo
 * @subpackage Structs
 ...
 */
/**
 * This class stands for QualitativoStructObterFinanciamentoExtraOrcamentarioPorIniciativa originally named obterFinanciamentoExtraOrcamentarioPorIniciativa
 ...
 * @date 2014-01-04
 */
class QualitativoStructObterFinanciamentoExtraOrcamentarioPorIniciativa extends QualitativoWsdlClass
{
	/**
	 * The credencial
	 * Meta informations extracted from the WSDL
	...
	/**
	 * Constructor method for obterFinanciamentoExtraOrcamentarioPorIniciativa
	 ...
	 * @return QualitativoStructObterFinanciamentoExtraOrcamentarioPorIniciativa
	 */
