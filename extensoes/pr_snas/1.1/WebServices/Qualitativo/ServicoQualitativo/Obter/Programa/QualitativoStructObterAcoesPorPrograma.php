<?php
/**
 * File for class QualitativoStructObterAcoesPorPrograma
 * @package Qualitativo
 * @subpackage Structs
 ...
 */
/**
 * This class stands for QualitativoStructObterAcoesPorPrograma originally named obterAcoesPorPrograma
 ...
 * @date 2014-01-04
 */
class QualitativoStructObterAcoesPorPrograma extends QualitativoWsdlClass
{
	/**
	 * The credencial
	 * Meta informations extracted from the WSDL
	...
	/**
	 * Constructor method for obterAcoesPorPrograma
	 ...
	 * @return QualitativoStructObterAcoesPorPrograma
	 */
