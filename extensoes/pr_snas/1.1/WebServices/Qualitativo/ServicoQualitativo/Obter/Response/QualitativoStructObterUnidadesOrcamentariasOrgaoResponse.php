<?php
/**
 * File for class QualitativoStructObterUnidadesOrcamentariasOrgaoResponse
 * @package Qualitativo
 * @subpackage Structs
 ...
 */
/**
 * This class stands for QualitativoStructObterUnidadesOrcamentariasOrgaoResponse originally named obterUnidadesOrcamentariasOrgaoResponse
 ...
 * @date 2014-01-04
 */
class QualitativoStructObterUnidadesOrcamentariasOrgaoResponse extends QualitativoWsdlClass
{
	/**
	 * The return
	 * Meta informations extracted from the WSDL
	...
	public $return;
	/**
	 * Constructor method for obterUnidadesOrcamentariasOrgaoResponse
