<?php
/**
 * File for class QualitativoStructObterIniciativasPorObjetivo
 * @package Qualitativo
 * @subpackage Structs
 ...
 */
/**
 * This class stands for QualitativoStructObterIniciativasPorObjetivo originally named obterIniciativasPorObjetivo
 ...
 * @date 2014-01-04
 */
class QualitativoStructObterIniciativasPorObjetivo extends QualitativoWsdlClass
{
	/**
	 * The credencial
	 * Meta informations extracted from the WSDL
	...
	/**
	 * Constructor method for obterIniciativasPorObjetivo
	 ...
	 * @return QualitativoStructObterIniciativasPorObjetivo
	 */
	public function __construct($_credencial = NULL,$_exercicio = NULL,$_codigoPrograma = NULL,$_codigoObjetivo = NULL,$_codigoMomento = NULL,$_dataHoraReferencia = NULL)
	{
		parent::__construct(array('credencial'=>$_credencial,'exercicio'=>$_exercicio,'codigoPrograma'=>$_codigoPrograma,'codigoObjetivo'=>$_codigoObjetivo,'codigoMomento'=>$_codigoMomento,'dataHoraReferencia'=>$_dataHoraReferencia));
	}
	/**
