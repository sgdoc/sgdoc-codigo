...
include(__BASE_PATH__ . '/extensoes/pr_snas/1.1/interfaces/detalhar_documentos.php');
...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle">
            ...
            #fieldsetPrazo legend {
            	font-weight: bold;
            }
            
            #fieldsetPrazo #solicitacao {
	            height: 100px;
	            overflow: auto;
            }
        ...
        <script type="text/javascript">
            ...
            var responder = function(id) {
                ...
                function(data) {
                    try {
                        if (data) {
			                $('#digital_pai').text(oTr.childNodes[1].innerText);
			                $('#nu_ref').text(oTr.childNodes[2].innerText);
			                $('#interessado').text(oTr.childNodes[3].innerText);
			                $('#remetente').text(oTr.childNodes[4].innerText);
			                $('#setor_remetente').text(oTr.childNodes[5].innerText);
			                $('#prazo').text(oTr.childNodes[7].innerText);
			                $('#solicitacao').html('<p>' + data.solicitacao + '</p>');
			            	$('#id_prazo').val(id);
			            	$('#dialog').dialog('open');
                        }
                    } catch (e) {
    ...
    <body>
        ...
        <div id="dialog" title="Responder ao Prazo">
                <fieldset id="fieldsetPrazo">
                	<legend>Dados do Prazo</legend>
                    <label for="digital_pai">D. Principal:</label>
                    <span id="digital_pai"></span>
                    <br/>
                    <label for="nu_ref">N. Referência:</label>
                    <span id="nu_ref"></span>
                    <br/>
                    ...
                    <span id="interessado"></span>
                    <br/>
                    <label for="remetente">Remetente:</label>
                    <span id="remetente"></span>
                    <br/>
                    <label for="setor_remetente">Setor Remetente:</label>
                    <span id="setor_remetente"></span>
                    <br/>
                    <br/>
