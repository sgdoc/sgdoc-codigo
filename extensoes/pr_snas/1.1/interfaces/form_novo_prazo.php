    ...
    $(document).ready(function() {
        ...
        $('#box-novo-prazo').dialog({
            ...
            open: function(event, ui) {
            	$('#txaDemanda').val('');
                $.post("extensoes/pr_snas/1.1/modelos/prazos/prazos.php", {
                ...
                Salvar: function() {
                    ...
                    if (validou == true) {
                        if (confirm('Você tem certeza que deseja enviar este novo prazo?\nOBS: Esta operação não poderá ser desfeita!')) {
                            ...
                            function(data) {
                                try {
                                    $('#div_grid_demandas_cadastradas').load('grid_demanda_cadastrada.php?DIGITAL_PAI=' + demandaAdicionadaPorPesquisa);
