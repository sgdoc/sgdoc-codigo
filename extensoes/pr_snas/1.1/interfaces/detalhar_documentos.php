...
include_once(__BASE_PATH__ . '/extensoes/pr_snas/1.1/interfaces/pesquisar_documentos.php');
...
<head>
<script
	src="<?php echo __URLSERVERAPP__.'/extensoes/pr_snas/1.1/javascripts/documentos.js'?>"></script>
...
<?php } ?>
            ...
            $('#div_grid_demandas_cadastradas').hide();
...
//                    if ($('#PRIORIDADE_DETALHAR_DOCUMENTO').val() != null){
//            var novaPrioridade = new Array();
//                    novaPrioridade.push($('#PRIORIDADE_DETALHAR_DOCUMENTO').val());
//                    novaPrioridade.push($('#PRIORIDADE_DETALHAR_DOCUMENTO option[value=' + novaPrioridade[0] + ']').text());
//            }
//            } else{
//            $('#extras').hide();
//            }
...
//                    novaPrioridade.push($('#PRIORIDADE_DETALHAR_DOCUMENTO').val());
//                    novaPrioridade.push($('#PRIORIDADE_DETALHAR_DOCUMENTO option[value=' + novaPrioridade[0] + ']').text());
//                    jquery_carregar_campos_extra($('#DIGITAL_DETALHAR_DOCUMENTO').val(), novaPrioridade);
//            }
//            } else{
//
//            jquery_carregar_campos_extra($('#DIGITAL_DETALHAR_DOCUMENTO').val(), false);
...
<body>
	...
	<div id="div-form-detalhar-documentos" class="div-form-dialog">
		<input type="hidden" id="ID_DETALHAR_DOCUMENTO"> <input type="hidden"
			id="HDN_ACAO">
		<div class="row">
			<label class="label">*DIGITAL:</label> <span class="conteudo"> <input
				disabled type="text" id="FAKE_DIGITAL_DETALHAR_DOCUMENTO"> <input
				disabled type="hidden" id="DIGITAL_DETALHAR_DOCUMENTO">
			</span>
		</div>

		<div class="row">
			<label class="label">*PROCEDENCIA:</label> <span class="conteudo"> <select
				id='PROCEDENCIA_DETALHAR_DOCUMENTO'>
		...
		<div class="row">
			<label class="label">*NUMERO:</label> <span class="conteudo"> <input
				type="text" id="NUMERO_DETALHAR_DOCUMENTO" maxlength="60"
				onKeyUp="DigitaLetraSeguro(this)">
			</span>
		</div>

		<div class="row">
			<label class="label">*TIPO:</label> <span class="conteudo"> <select
				id='TIPO_DETALHAR_DOCUMENTO'></select>
			</span>
		</div>

		<div class="row">
			<label class="label">*ORIGEM:</label> <span class="conteudo"> <select
				id="ORIGEM_DETALHAR_DOCUMENTO"></select>
			</span> <img title="Filtrar" class="botao-auxiliar-fix-combobox"
				id="botao-filtro-tipo-origem-detalhar-documentos"
				src="imagens/fam/application_edit.png">
		</div>

		<div class="row">
			<label class="label">*ASSUNTO:</label> <span class="conteudo"> <select
				onKeyUp="DigitaLetraSeguro(this)" class="FUNDOCAIXA1"
				id="ASSUNTO_DETALHAR_DOCUMENTO"></select>
			</span> <img title="Filtrar" class="botao-auxiliar-fix-combobox"
				id="botao-filtro-assunto-detalhar-documento"
				src="imagens/fam/application_edit.png">
		</div>

		<div class="row">
			<label class="label">ASSUNTO COMPLEMENTAR:</label> <span
				class="conteudo"> <input type="text"
				onKeyUp="DigitaLetraSeguro(this)"
				id="ASSUNTO_COMPLEMENTAR_DETALHAR_DOCUMENTO">
			</span>
		</div>
		<div id="div_prioridade">
			<div class="row">
				<label>PRIORIDADE:</label> <span class="conteudo"> <select
					type="text" id="PRIORIDADE_DETALHAR_DOCUMENTO"></select>
				</span>
			</div>
		</div>
		...
		<div id="extras">
			...
			<div class="row-prioridades">
				<div class="row">
					<label class="label">*PRIORIDADE(S):</label> <span class="conteudo">
						<select class="FUNDOCAIXA1" id="LISTA_PRIORIDADE"></select>
					</span> <img title="Adicionar" class="botao-auxiliar-fix-combobox"
						id="botao-adicionar-prioridade" src="imagens/fam/add.png"> <img
						title="Filtrar" class="botao-auxiliar-recuo-fix-combobox"
						id="botao-filtro-prioridade"
						src="imagens/fam/application_edit.png">
				</div>
			...
			<div class="row-participantes">
				<div class="row">
					<label class="label">*PARTICIPANTE(S):</label> <span
						class="conteudo"> <select class="FUNDOCAIXA1"
						id="LISTA_PARTICIPANTE"></select>
					</span> <img title="Adicionar" class="botao-auxiliar-fix-combobox"
						id="botao-adicionar-participante" src="imagens/fam/add.png"> <img
						title="Filtrar" class="botao-auxiliar-recuo-fix-combobox"
						id="botao-filtro-participante"
						src="imagens/fam/application_edit.png">
				</div>
			...
			<div class="row row-conteudo-ata">
				<label class="label">*CONTEÚDO:</label> <span class="conteudo"> <textarea
						class="FUNDOCAIXA1" id="CONTEUDO_ATA"
						style="width: 399px; height: 140px;"></textarea>
				</span>
			</div>
		</div>
		<!--EXTRAS-->
		...
		<div class="row">
			<label class="label">*DESTINO:</label> <span class="conteudo"> <select
				id="DESTINO_DETALHAR_DOCUMENTO"></select>
			</span> <img title="Filtrar" class="botao-auxiliar-fix-combobox"
				id="botao-filtro-destino-detalhar-documentos"
				src="imagens/fam/application_edit.png">
		</div>

		<div class="row">
			<label class="label">*ENCAMINHADO PARA:</label> <span
				class="conteudo"> <input type="text"
				onKeyUp="DigitaLetraSeguro(this)"
				id="TECNICO_RESPONSAVEL_DETALHAR_DOCUMENTO" maxlength="60">
			</span>
		</div>

		<div class="row">
			<label class="label">INTERESSADO:</label> <span class="conteudo"> <input
				type="text" onKeyUp="DigitaLetraSeguro(this)"
				id="INTERESSADO_DETALHAR_DOCUMENTO" maxlength="200">
			</span>
		</div>

		<div class="row">
			<label class="label">ASSINATURA:</label> <span class="conteudo"> <input
				type="text" onKeyUp="DigitaLetraSeguro(this)" class="FUNDOCAIXA1"
				id="ASSINATURA_DETALHAR_DOCUMENTO" maxlength="60">
			</span>
		</div>

		<div class="row">
			<label class="label">CARGO:</label> <span class="conteudo"> <input
				type="text" onKeyUp="DigitaLetraSeguro(this)"
				id="CARGO_DETALHAR_DOCUMENTO" maxlength="60">
			</span>
		</div>

		<div class="row">
			<label class="label">DATA DO PRAZO:</label> <span class="conteudo"> <input
				type="text" id="DATA_PRAZO_DETALHAR_DOCUMENTO" maxlength="10"
				readonly="true">
			</span> <span id="notificacao-prazo-detalhar-documento"
				class="notificacao-prazo-vermelho"></span> <input type="checkbox"
				id="STATUS_PRAZO_DETALHAR_DOCUMENTO"
				title="Ativar ou Desativar prazo geral documento."> <img
				title="Limpar" src="imagens/fam/delete.png"
				onClick="limparCampoData('DATA_PRAZO_DETALHAR_DOCUMENTO');"
				class="botao-auxiliar">
		</div>

		<div class="row">
			<label class="label">*DATA DO DOCUMENTO:</label> <span
				class="conteudo"> <input type="text"
				id="DATA_DOCUMENTO_DETALHAR_DOCUMENTO" maxlength="10"
				readonly="true">
			</span>
		</div>

		<div class="row">
			<label class="label">DATA DA ENTRADA:</label> <span class="conteudo">
				<input disabled type="text" id="DATA_ENTRADA_DETALHAR_DOCUMENTO"
				maxlength="10" readonly="true">
			</span>
		</div>

		<div class="row">
			<label class="label">RECEBIDO POR:</label> <span class="conteudo"> <input
				type="text" onKeyUp="DigitaLetraSeguro(this)" disabled="disabled"
				id="RECIBO_DETALHAR_DOCUMENTO" maxlength="60">
			</span>
		</div>
		<?php
		/**
		...
		<?php if (AclFactory::checaPermissao(Controlador::getInstance()->acl, Controlador::getInstance()->usuario, DaoRecurso::getRecursoById(310116))) { ?>
		<div style="margin-top: 10px"></div>
		<div id="div_grid_demandas_cadastradas"></div>
		<?php } ?>
		<div class="menu-detalhar-documentos">
			<?php Util::montaMenus($botoes, array('class' => 'botao32')); ?>
		</div>

		<div id="box-filtro-tipo-origem-detalhar-documentos"
			class="box-filtro">
			<div class="row">
				<label class="label">TIPO DE ORIGEM:</label> <span class="conteudo">
			...
			<div class="row">
				<label class="label">ORIGEM:</label> <span class="conteudo"> <input
					type="text" id="FILTRO_ORIGEM_DETALHAR_DOCUMENTO"
					onKeyUp="DigitaLetraSeguro(this)" class="FUNDOCAIXA1">
				</span>
			</div>
		</div>
		...
		<div id="box-filtro-destino-detalhar-documentos" class="box-filtro">
			<div class="row">
				<label class="label">TIPO DE DESTINO:</label> <span class="conteudo">
			...
			<div class="row">
				<label class="label">DESTINO:</label> <span class="conteudo"> <input
					type="text" id="FILTRO_DESTINO_DETALHAR_DOCUMENTO"
					onKeyUp="DigitaLetraSeguro(this)" class="FUNDOCAIXA1">
				</span>
			</div>
		</div>
		...
		<div id="box-filtro-assunto-detalhar-documento" class="box-filtro">
			<div class="row">
				<label>Assunto:</label>
				<div class="conteudo">
					<input type="text" id="FILTRO_ASSUNTO_DETALHAR_DOCUMENTO"
						onKeyUp="DigitaLetraSeguro(this)" class="FUNDOCAIXA1">
				</div>
			</div>
		</div>
	...
	<div id="box-filtro-prioridade" class="box-filtro">
		<div class="row">
			...
			<div class="conteudo">
				<input type="text" id="FILTRO_PRIORIDADE"
					onKeyUp="DigitaLetraSeguro(this)" class="FUNDOCAIXA1">
			</div>
		</div>
	</div>
	...
	<div id="box-filtro-participante" class="box-filtro">
		<div class="row">
			...
			<div class="conteudo">
				<input type="text" id="FILTRO_PARTICIPANTE"
					onKeyUp="DigitaLetraSeguro(this)" class="FUNDOCAIXA1">
			</div>
		</div>
	</div>
