...
//include(__BASE_PATH__ . '/extensoes/pr_snas/1.1/interfaces/form_novo_prazo.php'); // @todo essa linha foi comentada porque estava dando conflito...
include(__BASE_PATH__ . '/extensoes/pr_snas/1.1/interfaces/detalhar_documentos.php');
//include(__BASE_PATH__ . "/interfaces/lista_prazos.php");
                ...
                oTableDocumentos = $('#TabelaDocumentos').dataTable({
                    ...
                    fnRowCallback: function(nRow, aData, iDisplayIndex) {
                        ...
                        if (acao_pesquisa != null && acao_pesquisa == 'demanda')
                        {
                            ...
                            $("<img/>", {
                                src: '/extensoes/pr_snas/1.1/imagens/adicionar.png',
