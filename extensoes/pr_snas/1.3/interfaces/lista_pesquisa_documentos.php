...
//include(__BASE_PATH__ . '/extensoes/pr_snas/1.3/interfaces/form_novo_prazo.php'); // @todo essa linha foi comentada porque estava dando conflito...
include(__BASE_PATH__ . '/extensoes/pr_snas/1.3/interfaces/detalhar_documentos.php');
                ...
                oTableDocumentos = $('#TabelaDocumentos').dataTable({
                    ...
                    fnRowCallback: function(nRow, aData, iDisplayIndex) {
                        ...
                        if (acao_pesquisa != null && acao_pesquisa == 'demanda')
                        {
                            ...
                            $("<img/>", {
                                src: '/extensoes/pr_snas/1.3/imagens/adicionar.png',
