...
include_once(__BASE_PATH__ . '/extensoes/pr_snas/1.3/interfaces/pesquisar_documentos.php');

require_once __BASE_PATH__ . '/extensoes/pr_snas/1.3/interfaces/dialog_responder_prazo.php';

require_once (__BASE_PATH__ . '/extensoes/pr_snas/1.3/interfaces/form_novos_prazos_multiplos.php');
...
<html>
<head>
	<script	src="<?php echo __URLSERVERAPP__.'/extensoes/pr_snas/1.3/javascripts/documentos.js'?>"></script>
