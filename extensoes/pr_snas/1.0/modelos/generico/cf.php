...
include_once(__BASE_PATH__ . '/extensoes/pr_snas/1.0/classes/TPDocumentoDemanda.php');
include_once(__BASE_PATH__ . '/extensoes/pr_snas/1.0/classes/CFModelDocumentoCamposDemanda.php');
