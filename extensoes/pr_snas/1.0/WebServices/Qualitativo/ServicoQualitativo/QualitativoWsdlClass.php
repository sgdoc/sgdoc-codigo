<?php
/**
 * File for QualitativoWsdlClass to communicate with SOAP service
 * @package Qualitativo
 ...
 */
/**
 * QualitativoWsdlClass to communicate with SOAP service
 * 
 * @package Qualitativo
 * @author Mikaël DELSOL <contact@wsdltophp.com>
 * @version 20131207-01
 * @date 2014-01-04
 */
class QualitativoWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	/**
	...
	/**
	 * Constructor
	 * @uses QualitativoWsdlClass::setLastError()
	 * @uses QualitativoWsdlClass::initSoapClient()
	 * @uses QualitativoWsdlClass::initInternArrayToIterate()
	 * @uses QualitativoWsdlClass::_set()
	 ...
	 * @return QualitativoWsdlClass|null
	 */
	public static function __set_state(array $_array,$_className = __CLASS__)
	{
		if(class_exists($_className))
		{
			...
			if(is_object($object) && is_subclass_of($object,'QualitativoWsdlClass'))
			{
	 ...
	 * @uses QualitativoClassMap::classMap()
	 * @uses QualitativoWsdlClass::getDefaultWsdlOptions()
	 * @uses QualitativoWsdlClass::setSoapClient()
	 * @param array $_wsdlOptions WSDL options
	 * @return void
	 */
	public function initSoapClient($_wsdlOptions)
	{
		if(class_exists('QualitativoClassMap',true))
		{
			$wsdlOptions = array();
			$wsdlOptions['classmap'] = QualitativoClassMap::classMap();
	 ...
	 * @uses QualitativoWsdlClass::WSDL_CACHE_WSDL
	 * @uses QualitativoWsdlClass::WSDL_COMPRESSION
	 * @uses QualitativoWsdlClass::WSDL_CONNECTION_TIMEOUT
	 * @uses QualitativoWsdlClass::WSDL_ENCODING
	 * @uses QualitativoWsdlClass::WSDL_EXCPTS
	 * @uses QualitativoWsdlClass::WSDL_FEATURES
	 * @uses QualitativoWsdlClass::WSDL_LOGIN
	 * @uses QualitativoWsdlClass::WSDL_PASSWD
	 * @uses QualitativoWsdlClass::WSDL_SOAP_VERSION
	 * @uses QualitativoWsdlClass::WSDL_STREAM_CONTEXT
	 * @uses QualitativoWsdlClass::WSDL_TRACE
	 * @uses QualitativoWsdlClass::WSDL_TYPEMAP
	 * @uses QualitativoWsdlClass::WSDL_URL
	 * @uses QualitativoWsdlClass::WSDL_USER_AGENT
	 ...
	 * @uses QualitativoWsdlClass::getSoapClient()
	 * @uses QualitativoWsdlClass::getFormatedXml()
	 ...
	 * @uses QualitativoWsdlClass::getSoapClient()
	 * @uses QualitativoWsdlClass::convertStringHeadersToArray()
	 ...
	 * @uses QualitativoWsdlClass::count()
	 * @return int
	 */
	 ...
	 * @uses QualitativoWsdlClass::getInternArrayToIterate()
	 * @uses QualitativoWsdlClass::getInternArrayToIterateIsArray()
	 * @return int
	 */
	 ...
	 * @uses QualitativoWsdlClass::offsetGet()
	 * @return mixed
	 */
	 ...
	 * @uses QualitativoWsdlClass::getInternArrayToIterateOffset()
	 * @uses QualitativoWsdlClass::setInternArrayToIterateOffset()
	 * @return int
	 */
	 ...
	 * @uses QualitativoWsdlClass::getInternArrayToIterateOffset()
	 * @uses QualitativoWsdlClass::offsetExists()
	 * @return bool true|false
	 */
	 ...
	 * @see QualitativoWsdlClass::offsetGet()
	 * @uses QualitativoWsdlClass::offsetGet()
	 * @param int $_index
	 * @return mixed
	 */
	 ...
	 * @uses QualitativoWsdlClass::getAttributeName()
	 * @uses QualitativoWsdlClass::__toString()
	 * @uses QualitativoWsdlClass::_set()
	 * @uses QualitativoWsdlClass::_get()
	 * @uses QualitativoWsdlClass::setInternArrayToIterate()
	 * @uses QualitativoWsdlClass::setInternArrayToIterateIsArray()
	 * @uses QualitativoWsdlClass::setInternArrayToIterateOffset()
	 ...
	 * @uses QualitativoWsdlClass::item()
	 * @return mixed
	 */
	 ...
	 * @uses QualitativoWsdlClass::item()
	 * @uses QualitativoWsdlClass::length()
	 * @return mixed
	 */
