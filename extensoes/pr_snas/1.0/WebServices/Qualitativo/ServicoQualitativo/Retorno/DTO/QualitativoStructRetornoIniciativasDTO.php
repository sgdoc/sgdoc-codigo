<?php
/**
 * File for class QualitativoStructRetornoIniciativasDTO
 * @package Qualitativo
 * @subpackage Structs
 ...
 */
/**
 * This class stands for QualitativoStructRetornoIniciativasDTO originally named retornoIniciativasDTO
 ...
 * @date 2014-01-04
 */
class QualitativoStructRetornoIniciativasDTO extends QualitativoStructRetornoDTO
{
	/**
	 * The registros
	 * Meta informations extracted from the WSDL
	...
	public $registros;
	/**
	 * Constructor method for retornoIniciativasDTO
	 * @see parent::__construct()
	 * @param QualitativoStructIniciativaDTO $_registros
	...
	/**
	 * Set registros value
	 * @param QualitativoStructIniciativaDTO $_registros the registros
