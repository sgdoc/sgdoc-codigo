<?php
/**
 * File for class QualitativoStructRetornoProgramasDTO
 * @package Qualitativo
 * @subpackage Structs
 ...
 */
/**
 * This class stands for QualitativoStructRetornoProgramasDTO originally named retornoProgramasDTO
 ...
 * @date 2014-01-04
 */
class QualitativoStructRetornoProgramasDTO extends QualitativoStructRetornoDTO
{
	/**
	 * The registros
	 * Meta informations extracted from the WSDL
	...
	public $registros;
	/**
	 * Constructor method for retornoProgramasDTO
	 * @see parent::__construct()
	 * @param QualitativoStructProgramaDTO $_registros
	...
	/**
	 * Set registros value
	 * @param QualitativoStructProgramaDTO $_registros the registros
