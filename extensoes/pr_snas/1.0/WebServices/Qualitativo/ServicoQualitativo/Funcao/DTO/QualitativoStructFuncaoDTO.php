<?php
/**
 * File for class QualitativoStructFuncaoDTO
 * @package Qualitativo
 * @subpackage Structs
 ...
 */
/**
 * This class stands for QualitativoStructFuncaoDTO originally named funcaoDTO
 ...
 * @date 2014-01-04
 */
class QualitativoStructFuncaoDTO extends QualitativoWsdlClass
{
	/**
	 * The codigoFuncao
	 * Meta informations extracted from the WSDL
	...
	public $snAtivo;
	/**
	 * Constructor method for funcaoDTO
	 ...
	 */
	public function __construct($_codigoFuncao = NULL,$_dataHoraAlteracao = NULL,$_descricao = NULL,$_descricaoAbreviada = NULL,$_exercicio = NULL,$_snAtivo = NULL)
	{
		parent::__construct(array('codigoFuncao'=>$_codigoFuncao,'dataHoraAlteracao'=>$_dataHoraAlteracao,'descricao'=>$_descricao,'descricaoAbreviada'=>$_descricaoAbreviada,'exercicio'=>$_exercicio,'snAtivo'=>$_snAtivo));
	}
	/**
