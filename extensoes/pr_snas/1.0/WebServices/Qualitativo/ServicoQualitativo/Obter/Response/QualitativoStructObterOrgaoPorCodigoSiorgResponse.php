<?php
/**
 * File for class QualitativoStructObterOrgaoPorCodigoSiorgResponse
 * @package Qualitativo
 * @subpackage Structs
 ...
 */
/**
 * This class stands for QualitativoStructObterOrgaoPorCodigoSiorgResponse originally named obterOrgaoPorCodigoSiorgResponse
 ...
 * @date 2014-01-04
 */
class QualitativoStructObterOrgaoPorCodigoSiorgResponse extends QualitativoWsdlClass
{
	/**
	 * The return
	 * Meta informations extracted from the WSDL
	...
	public $return;
	/**
	 * Constructor method for obterOrgaoPorCodigoSiorgResponse
