<?php
/**
 * File for class QualitativoStructObterAcoesPorProgramaResponse
 * @package Qualitativo
 * @subpackage Structs
 ...
 */
/**
 * This class stands for QualitativoStructObterAcoesPorProgramaResponse originally named obterAcoesPorProgramaResponse
 ...
 * @date 2014-01-04
 */
class QualitativoStructObterAcoesPorProgramaResponse extends QualitativoWsdlClass
{
	/**
	 * The return
	 * Meta informations extracted from the WSDL
	...
	public $return;
	/**
	 * Constructor method for obterAcoesPorProgramaResponse
