<?php
/**
 * File for class QualitativoStructObterAcaoPorIdentificadorUnicoResponse
 * @package Qualitativo
 * @subpackage Structs
 ...
 */
/**
 * This class stands for QualitativoStructObterAcaoPorIdentificadorUnicoResponse originally named obterAcaoPorIdentificadorUnicoResponse
 ...
 * @date 2014-01-04
 */
class QualitativoStructObterAcaoPorIdentificadorUnicoResponse extends QualitativoWsdlClass
{
	/**
	 * The return
	 * Meta informations extracted from the WSDL
	...
	public $return;
	/**
	 * Constructor method for obterAcaoPorIdentificadorUnicoResponse
