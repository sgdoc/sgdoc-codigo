<?php
/**
 * File for class QualitativoStructObterLocalizadoresPorAcao
 * @package Qualitativo
 * @subpackage Structs
 ...
 */
/**
 * This class stands for QualitativoStructObterLocalizadoresPorAcao originally named obterLocalizadoresPorAcao
 ...
 * @date 2014-01-04
 */
class QualitativoStructObterLocalizadoresPorAcao extends QualitativoWsdlClass
{
	/**
	 * The credencial
	 * Meta informations extracted from the WSDL
	...
	/**
	 * Constructor method for obterLocalizadoresPorAcao
	 ...
	 * @return QualitativoStructObterLocalizadoresPorAcao
	 */
	public function __construct($_credencial = NULL,$_exercicio = NULL,$_identificadorUnicoAcao = NULL,$_codigoMomento = NULL,$_dataHoraReferencia = NULL)
	{
		parent::__construct(array('credencial'=>$_credencial,'exercicio'=>$_exercicio,'identificadorUnicoAcao'=>$_identificadorUnicoAcao,'codigoMomento'=>$_codigoMomento,'dataHoraReferencia'=>$_dataHoraReferencia));
	}
	/**
