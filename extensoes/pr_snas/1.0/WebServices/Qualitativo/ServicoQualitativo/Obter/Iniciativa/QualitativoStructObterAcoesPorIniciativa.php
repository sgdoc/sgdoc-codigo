<?php
/**
 * File for class QualitativoStructObterAcoesPorIniciativa
 * @package Qualitativo
 * @subpackage Structs
 ...
 */
/**
 * This class stands for QualitativoStructObterAcoesPorIniciativa originally named obterAcoesPorIniciativa
 ...
 * @date 2014-01-04
 */
class QualitativoStructObterAcoesPorIniciativa extends QualitativoWsdlClass
{
	/**
	 * The credencial
	 * Meta informations extracted from the WSDL
	...
	/**
	 * Constructor method for obterAcoesPorIniciativa
	 ...
	 * @return QualitativoStructObterAcoesPorIniciativa
	 */
	public function __construct($_credencial = NULL,$_exercicio = NULL,$_codigoPrograma = NULL,$_codigoObjetivo = NULL,$_codigoIniciativa = NULL,$_codigoMomento = NULL,$_dataHoraReferencia = NULL)
	{
		parent::__construct(array('credencial'=>$_credencial,'exercicio'=>$_exercicio,'codigoPrograma'=>$_codigoPrograma,'codigoObjetivo'=>$_codigoObjetivo,'codigoIniciativa'=>$_codigoIniciativa,'codigoMomento'=>$_codigoMomento,'dataHoraReferencia'=>$_dataHoraReferencia));
	}
	/**
