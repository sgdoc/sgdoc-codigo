<?php
/**
 * File for class QualitativoStructObterIndicadoresPorPrograma
 * @package Qualitativo
 * @subpackage Structs
 ...
 */
/**
 * This class stands for QualitativoStructObterIndicadoresPorPrograma originally named obterIndicadoresPorPrograma
 ...
 * @date 2014-01-04
 */
class QualitativoStructObterIndicadoresPorPrograma extends QualitativoWsdlClass
{
	/**
	 * The credencial
	 * Meta informations extracted from the WSDL
	...
	/**
	 * Constructor method for obterIndicadoresPorPrograma
	 ...
	 * @return QualitativoStructObterIndicadoresPorPrograma
	 */
