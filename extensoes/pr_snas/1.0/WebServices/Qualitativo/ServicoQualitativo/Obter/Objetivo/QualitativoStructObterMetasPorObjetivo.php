<?php
/**
 * File for class QualitativoStructObterMetasPorObjetivo
 * @package Qualitativo
 * @subpackage Structs
 ...
 */
/**
 * This class stands for QualitativoStructObterMetasPorObjetivo originally named obterMetasPorObjetivo
 ...
 * @date 2014-01-04
 */
class QualitativoStructObterMetasPorObjetivo extends QualitativoWsdlClass
{
	/**
	 * The credencial
	 * Meta informations extracted from the WSDL
	...
	/**
	 * Constructor method for obterMetasPorObjetivo
	 ...
	 * @return QualitativoStructObterMetasPorObjetivo
	 */
