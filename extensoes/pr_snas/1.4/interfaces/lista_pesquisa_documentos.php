...
//include(__BASE_PATH__ . '/extensoes/pr_snas/1.4/interfaces/form_novo_prazo.php'); // @todo essa linha foi comentada porque estava dando conflito...
                ...
                oTableDocumentos = $('#TabelaDocumentos').dataTable({
                    ...
                    fnRowCallback: function(nRow, aData, iDisplayIndex) {
                        ...
                        if (acao_pesquisa != null && acao_pesquisa == 'demanda')
                        {
                            ...
                            $("<img/>", {
                                src: '/extensoes/pr_snas/1.4/imagens/adicionar.png',
