...
include_once(__BASE_PATH__ . '/extensoes/pr_snas/1.7/interfaces/pesquisar_documentos.php');

require_once __BASE_PATH__ . '/extensoes/pr_snas/1.7/interfaces/dialog_exportar_dados.php';

require_once __BASE_PATH__ . '/extensoes/pr_snas/1.7/interfaces/dialog_responder_prazo.php';

require_once (__BASE_PATH__ . '/extensoes/pr_snas/1.7/interfaces/form_novos_prazos_multiplos.php');
...
<html>
<head>
	<script	src="<?php echo '/extensoes/pr_snas/1.7/javascripts/documentos.js'?>"></script>
