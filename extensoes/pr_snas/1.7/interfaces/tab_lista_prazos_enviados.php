        ...
        oTableEnviados = $('#tabela_prazos_enviados').dataTable({
            ...
            fnRowCallback: function(nRow, aData, iDisplayIndex) {
                ...
                if (aData[8] == 1 || aData[8] == 2) {
                    ...
                    $('td:eq(8)', nRow).html('<blink>Atenção! Falta(m) ' + (aData[7]) + ' dia(s)</blink>');
                } else if (aData[8] <= 0) {
                    $('td', nRow).removeClass('vermelho');
                    $('td', nRow).addClass('vermelho');
                    if (aData[8] == 0) {
                        $('td:eq(8)', nRow).html('<blink>Atenção! Esgota hoje!</blink>');
                    } else {
                        $('td:eq(8)', nRow).html('<blink>Atenção! Esgotado a ' + (-1 * aData[8]) + ' dia(s)<blink>');
                    }
                } else if (aData[8] <= 8) {
...
<table class="display" border="0" id="tabela_prazos_enviados">
    <thead>
        <tr>
            ...
            <th class="style13">N. Referências</th>
