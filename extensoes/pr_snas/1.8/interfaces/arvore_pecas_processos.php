...
$urlManager = __BASE_PATH__ . "/extensoes/pr_snas/1.8/modelos/arvores/listar_todos_vinculos_documentos.php";
    ...
    <body>
        ...
        <ul id="tree-apensos-processos" class="arvoreDocumentos">
            ...
            <li class="<?php print($classe); ?>" id='<?php print($arvore->getRootId()); ?>'>
            	<span title="Processo mais relevante da arvore"><?php print($numero_processo); ?></span>
