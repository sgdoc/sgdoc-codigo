...
if ($_REQUEST['acao_pesquisa'] == "null") {
    include(__BASE_PATH__ . '/extensoes/pr_snas/1.8/interfaces/detalhar_documentos.php');
}
    ...
    $(document).ready(function() {
        ...
        $('#box-novo-prazo').dialog({
            ...
            open: function(event, ui) {
            	$('#txaDemanda').val('');
            	$('#tx_solicitacao').val('');
                $.post("extensoes/pr_snas/1.8/modelos/prazos/prazos.php", {
...
<div id="box-novo-prazo" class="div-form-dialog" title="Novo Prazo">
    ...
    <fieldset>
        ...
        <div style="text-align: left;">
            <label for="txaDemanda" class="label">Texto Original da Demanda:</label>
            <br/>
            <textarea id="txaDemanda" class="FUNDOCAIXA1" readonly="readonly" style="width: 100%; height: 150px;"></textarea>
        </div>
        <div style="text-align: left;">
            <label for="tx_solicitacao" class="label">*Conteúdo da Solicitação:</label>
            <br/>
            <textarea id="tx_solicitacao" class="FUNDOCAIXA1" onkeyup="DigitaLetraSeguro(this)" style="width: 100%; height: 200px;"></textarea>
        </div>
    </fieldset>
</div>
