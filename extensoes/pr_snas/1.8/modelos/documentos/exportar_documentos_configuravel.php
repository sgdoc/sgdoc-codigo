...
include_once(__BASE_PATH__ . '/extensoes/pr_snas/1.8/classes/DaoDocumentoDemanda.php');
include_once(__BASE_PATH__ . '/extensoes/pr_snas/1.8/classes/DaoPrazoDemanda.php');
include_once(__BASE_PATH__ . '/extensoes/pr_snas/1.8/classes/VinculacaoDemanda.php');
...
if ($_POST) {
	...
	*/
	$strOpcoes = '[{"id":"todas",
			...
			{"id":"prz-assunto", "label":"Assunto", "campo":"assunto"},
			{"id":"prz-assunto_complementar", "label":"Assunto Complementar", "campo":"assunto_complementar"},			
