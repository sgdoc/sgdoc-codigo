...
include_once(__BASE_PATH__ . '/extensoes/pr_snas/1.8/classes/CFModelControlePrazosDemanda.php');
...
class TPDocumentoDemanda {
    ...
    public function generatePDF($content) {
        ...
        include_once('bibliotecas/fpdf/fpdf.php');
        include_once('bibliotecas/barcode/code128.php');
