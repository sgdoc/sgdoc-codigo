...
include(__BASE_PATH__ . '/extensoes/pr_snas/1.6/classes/Prazo.php');
include(__BASE_PATH__ . '/extensoes/pr_snas/1.6/classes/DaoPrazoDemanda.php');
include(__BASE_PATH__ . '/extensoes/pr_snas/1.6/classes/UploaderPdfResposta.php');
