...
include_once(__BASE_PATH__ . '/extensoes/pr_snas/1.6/interfaces/pesquisar_documentos.php');

require_once __BASE_PATH__ . '/extensoes/pr_snas/1.6/interfaces/dialog_exportar_dados.php';

require_once __BASE_PATH__ . '/extensoes/pr_snas/1.6/interfaces/dialog_responder_prazo.php';

require_once (__BASE_PATH__ . '/extensoes/pr_snas/1.6/interfaces/form_novos_prazos_multiplos.php');
...
<html>
<head>
	<script	src="<?php echo '/extensoes/pr_snas/1.6/javascripts/documentos.js'?>"></script>
