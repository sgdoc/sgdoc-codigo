...
<html>
    <head>
        <script src="<?php echo __URLSERVERAPP__.'/extensoes/serpro/1.0/javascripts/documentos.js'?>"></script>
    ...
    <body>
        ...
        <div id="div-form-detalhar-documentos" class="div-form-dialog">
            ...
            <div class="row" >
                <label class="label">*DIGITAL___:</label>
                <span class="conteudo">
                    <input disabled type="text" id="DIGITAL_DETALHAR_DOCUMENTO__SERPRO">
                </span>
            </div>
            <div class="row" >
