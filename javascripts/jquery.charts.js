                ...
                if (config.showgrid) {
                    ...
                    for (var i = 0; i < gridLineCount; i++) {
                        ...
                        if (config.gridvalues) {
                            ...
                            output += "<span style=\"display: inline-block; width: 3em; position: relative; left: -3em; border-top: 1px solid Gray;\">" + value.toFixed(1) + "</span>";
                        }
                        output += "</div>";
                    }
                }
            ...
            return this.each(function () {
                ...
                for (var i = 0; i < values.length; i++) {
                    ...
                    if (valueString.length > 0) {
                        ...
                        valor = valueString.replace(".", "");
                        valueAmount = parseInt(valor);
...
//                    $Label.find("div").css({
//                        "text-align": "center", 
//                        color: $Bar.css("background-color"), 
//                        "background-color": $Bar.css("color")
//                    });
