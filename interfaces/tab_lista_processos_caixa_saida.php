...
<script type="text/javascript">
    ...
    function jquery_cancelar_tramite_processos(numero_processo) {
        try {
            var c = confirm('Você tem certeza que deseja cancelar o tramite deste(s) processo(s)?\n[' + numero_processo + ']\nObs:Todos processos vinculados terão o seu trâmite cancelado!');
            if (c) {
                $("#progressbar").show();
    ...
    $(document).ready(function() {
        ...
        oTableProcessos = $('#TabelaProcessos').dataTable({
            ...
            sAjaxSource: "modelos/processos/listar_processos_caixa_saida.php",
            oLanguage: {
...
if (AclFactory::checaPermissao(Controlador::getInstance()->acl, Controlador::getInstance()->usuario, DaoRecurso::getRecursoById(401))) {
    ?>
                    ...
                    $("<img/>", {
                        ...
                        jquery_cancelar_tramite_processos(aData[3]);
                    }).appendTo($line);
