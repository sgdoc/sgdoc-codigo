...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            #link-desapensar,#link-desanexar{
                background-image: url("imagens/fam/delete.png");
                background-repeat: no-repeat;
                padding-left: 20px;
                background-position: 2px 2px;
            }
            #IFRAME_ANEXOS_DOCUMENTO,#IFRAME_APENSOS_DOCUMENTO{
                height: 80%;
                width: 100%;
            }
        </style>
        ...
        <script type="text/javascript">
            ...
            function jquery_desvincular_documento(pai,filho,vinculacao){
                try{
                    ...
                    switch (vinculacao) {
                        case 1: var operacao = 'desanexar'; break;
                        case 2: var operacao = 'desapensar'; break;
                        default:
