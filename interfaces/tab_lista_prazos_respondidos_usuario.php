...
<script type="text/javascript">
    ...
    var oTableRespondidosUsuario = null;

    $(document).ready(function() {
        $('#tabs-prazos-respondidos-usu').click(function() {
            oTableRespondidosUsuario.fnDraw(false);
        });

        /*DataTable*/
        oTableRespondidosUsuario = $('#tabela_prazos_respondidos_pelos_usuarios').dataTable({
            ...
            sAjaxSource: "modelos/prazos/listar_prazos_respondidos_pelos_usuarios.php",
            oLanguage: {
            ...
            fnServerData: function(sSource, aoData, fnCallback) {
                $.getJSON(sSource, aoData, function(json) {
                    ...
                    if (json.iTotalRecords == 0) {
                        jquery_datatable_complementa_mensagem_vazia('tabela_prazos_respondidos_pelos_usuarios');
                    }
                });
            },
            fnRowCallback: function(nRow, aData, iDisplayIndex) {
                ...
                if (aData[3].length == 20 || aData[3].length == 18) {
                    $('td:eq(3)', nRow).html('<span title="Detalhar Processo" onclick=detalhar_processo("' + aData[3] + '");>' + aData[3] + '</span>');
                }
                if (aData[3] == '') {
...
<table class="display" border="0" id="tabela_prazos_respondidos_pelos_usuarios">
    <thead>
        <tr>
            <th class="style13">#</th>
