...
<html>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                oTabelaHistoricos = $('#TabelaHistoricos').dataTable({
                    ...
                    aaSorting: [[ 1, "desc" ]],
                    sAjaxSource: "modelos/historicos/listar_historicos_documentos_processos.php?usercase=historico-comentarios-documentos&digital=<?php echo $_GET['digital'] ?>",
                    oLanguage: {
    ...
    <body>
        <div class="cabecalho-caixas">
            ...
            <div class="titulo-historico">Comentários - <?php echo $_GET['digital'] ?></div>
