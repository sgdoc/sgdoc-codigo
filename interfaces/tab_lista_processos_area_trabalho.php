...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        oTableProcessos = $('#TabelaProcessos').dataTable({
            ...
            sAjaxSource: "modelos/processos/listar_processos_trabalho.php",
            oLanguage: {
...
<?php
// verifica a existencia da permissao para tramitar processos
if (AclFactory::checaPermissao(Controlador::getInstance()->acl, Controlador::getInstance()->usuario, DaoRecurso::getRecursoById(308))) {
    ?>
                    // Tramitar
                    $("<img/>", {
                        src: 'imagens/tramitarp.png',
                        title: 'Tramitar Processo',
                        'class': 'botao30'
                    }).bind("click", function() {
                        jquery_tramitar_processo(aData[3]);
                    }).appendTo($line);
...
if (AclFactory::checaPermissao(Controlador::getInstance()->acl, Controlador::getInstance()->usuario, DaoRecurso::getRecursoById(3111))) {
    ?>
                    ...
                    $("<img/>", {
                        ...
                        jquery_listar_vinculacao_processo(aData[3], true);
                    }).appendTo($line);
