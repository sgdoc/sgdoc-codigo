...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#tabs-prazos-rec-set').click(function(){oTableRecebidosSetor.fnDraw(false);});
        ...
        oTableRecebidosSetor = $('#tabela_prazos_recebidos_setor').dataTable( {
            ...
            fnRowCallback: function( nRow, aData, iDisplayIndex ) {
                ...
                var unidadePermitida = aData[9];
                if( unidadeDoUsuario == unidadePermitida ){
                    $('td:eq(8)', nRow).html('<img title="Responder" src="imagens/responder_prazo.png" class="botao32" onclick="responder('+aData[0]+');" />');
                }else{
                    $('td:eq(8)', nRow).html('<img title="Responder" src="imagens/responder_prazo_desabilitado.png" class="botao32" onclick="__emiteMsgRespostaDesabilitada();" />');
                }
