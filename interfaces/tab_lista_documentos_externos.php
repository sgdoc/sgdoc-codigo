...
<script type="text/javascript">
    ...
    /*Funcoes*/
    function jquery_resgatar_documentos(digital) {
        try {
            var c = confirm('Você tem certeza que deseja resgatar este(s) documento(s) para a sua área de trabalho?\n[' + digital + ']\nObs:Todos documentos vinculados também serão resgatados!');
            if (c) {
                $("#progressbar").show();
    ...
    $(document).ready(function() {
        ...
        oTableDocumentos = $('#TabelaDocumentos').dataTable({
            ...
            sAjaxSource: "modelos/documentos/listar_documentos_caixa_externo.php",
            oLanguage: {
...
<?php
// verifica a existencia da permissao para retornar documentos externos
if (AclFactory::checaPermissao(Controlador::getInstance()->acl, Controlador::getInstance()->usuario, DaoRecurso::getRecursoById(501))) {
    ?>
                    // Resgatar
                    $("<img/>", {
                        ...
                        jquery_resgatar_documentos(aData[3]);
                    }).appendTo($line);
