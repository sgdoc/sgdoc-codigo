...
<script type="text/javascript">
    ...
    var oTableRespostasSetor = null;

    $(document).ready(function() {
        $('#tabs-prazos-respostas-set').click(function() {
            oTableRespostasSetor.fnDraw(false);
        });

        /*DataTable*/
        oTableRespostasSetor = $('#tabela_prazos_respostas_setor').dataTable({
            ...
            sAjaxSource: "modelos/prazos/listar_prazos_respostas_setor.php",
            oLanguage: {
            ...
            fnServerData: function(sSource, aoData, fnCallback) {
                $.getJSON(sSource, aoData, function(json) {
                    ...
                    if (json.iTotalRecords == 0) {
                        jquery_datatable_complementa_mensagem_vazia('tabela_prazos_respostas_setor');
                    }
                });
            },
            fnRowCallback: function(nRow, aData, iDisplayIndex) {
                /* Append the grade to the default row class name */
                nRow.setAttribute('title', aData[6]);
...
<table class="display" border="0" id="tabela_prazos_respostas_setor">
    <thead>
        <tr>
            <th class="style13">#</th>
    ...
    <tbody>
        <tr>
            <td colspan="5" title="test" class="dataTables_empty">Nenhuma resposta encontrada para prazos do seu setor!</td>
        </tr>
    </tbody>
</table>
