...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $('#TabelaHistoricos').dataTable({
                    ...
                    sAjaxSource: "modelos/historicos/listar_historicos_documentos_processos.php?usercase=historico-tramite-processos&numero_processo=<?php echo $_GET['numero_processo'] ?>",
                    aaSorting: [[6, "desc"]],
                    oLanguage: {
        ...
        <title>Histórico do processo</title>
    </head>
    <body>
        <div class="cabecalho-caixas">
            <div class="logo-historico-tramite"></div>
            <div class="titulo-historico">Histórico do processo - <?php echo $_GET['numero_processo'] ?></div>
            ...
            <table class="display" border="0" id="TabelaHistoricos">
                <thead>
                    <tr>
                        ...
                        <th class="style13 column-numero-processo">Unidade</th>
